...
enum opt_code
{
  ...
  OPT__param_aarch64_sve_compare_costs_ = 62,/* --param=aarch64-sve-compare-costs= */
  OPT__param_align_loop_iterations_ = 63,    /* --param=align-loop-iterations= */
  OPT__param_align_threshold_ = 64,          /* --param=align-threshold= */
  OPT__param_asan_globals_ = 65,             /* --param=asan-globals= */
  OPT__param_asan_instrument_allocas_ = 66,  /* --param=asan-instrument-allocas= */
  OPT__param_asan_instrument_reads_ = 67,    /* --param=asan-instrument-reads= */
  OPT__param_asan_instrument_writes_ = 68,   /* --param=asan-instrument-writes= */
  OPT__param_asan_instrumentation_with_call_threshold_ = 69,/* --param=asan-instrumentation-with-call-threshold= */
  OPT__param_asan_memintrin_ = 70,           /* --param=asan-memintrin= */
  OPT__param_asan_stack_ = 71,               /* --param=asan-stack= */
  OPT__param_asan_use_after_return_ = 72,    /* --param=asan-use-after-return= */
  OPT__param_avg_loop_niter_ = 73,           /* --param=avg-loop-niter= */
  OPT__param_avoid_fma_max_bits_ = 74,       /* --param=avoid-fma-max-bits= */
  OPT__param_builtin_expect_probability_ = 75,/* --param=builtin-expect-probability= */
  OPT__param_builtin_string_cmp_inline_length_ = 76,/* --param=builtin-string-cmp-inline-length= */
  OPT__param_case_values_threshold_ = 77,    /* --param=case-values-threshold= */
  OPT__param_comdat_sharing_probability_ = 78,/* --param=comdat-sharing-probability= */
  OPT__param_cxx_max_namespaces_for_diagnostic_help_ = 79,/* --param=cxx-max-namespaces-for-diagnostic-help= */
  OPT__param_dse_max_alias_queries_per_store_ = 80,/* --param=dse-max-alias-queries-per-store= */
  OPT__param_dse_max_object_size_ = 81,      /* --param=dse-max-object-size= */
  OPT__param_early_inlining_insns_ = 82,     /* --param=early-inlining-insns= */
  OPT__param_fsm_maximum_phi_arguments_ = 83,/* --param=fsm-maximum-phi-arguments= */
  OPT__param_fsm_scale_path_blocks_ = 84,    /* --param=fsm-scale-path-blocks= */
  OPT__param_fsm_scale_path_stmts_ = 85,     /* --param=fsm-scale-path-stmts= */
  OPT__param_gcse_after_reload_critical_fraction_ = 86,/* --param=gcse-after-reload-critical-fraction= */
  OPT__param_gcse_after_reload_partial_fraction_ = 87,/* --param=gcse-after-reload-partial-fraction= */
  OPT__param_gcse_cost_distance_ratio_ = 88, /* --param=gcse-cost-distance-ratio= */
  OPT__param_gcse_unrestricted_cost_ = 89,   /* --param=gcse-unrestricted-cost= */
  OPT__param_ggc_min_expand_ = 90,           /* --param=ggc-min-expand= */
  OPT__param_ggc_min_heapsize_ = 91,         /* --param=ggc-min-heapsize= */
  OPT__param_gimple_fe_computed_hot_bb_threshold_ = 92,/* --param=gimple-fe-computed-hot-bb-threshold= */
  OPT__param_graphite_allow_codegen_errors_ = 93,/* --param=graphite-allow-codegen-errors= */
  OPT__param_graphite_max_arrays_per_scop_ = 94,/* --param=graphite-max-arrays-per-scop= */
  OPT__param_graphite_max_nb_scop_params_ = 95,/* --param=graphite-max-nb-scop-params= */
  OPT__param_hash_table_verification_limit_ = 96,/* --param=hash-table-verification-limit= */
  OPT__param_hot_bb_count_fraction_ = 97,    /* --param=hot-bb-count-fraction= */
  OPT__param_hot_bb_count_ws_permille_ = 98, /* --param=hot-bb-count-ws-permille= */
  OPT__param_hot_bb_frequency_fraction_ = 99,/* --param=hot-bb-frequency-fraction= */
  OPT__param_hsa_gen_debug_stores_ = 100,    /* --param=hsa-gen-debug-stores= */
  OPT__param_inline_heuristics_hint_percent_ = 101,/* --param=inline-heuristics-hint-percent= */
  OPT__param_inline_min_speedup_ = 102,      /* --param=inline-min-speedup= */
  OPT__param_inline_unit_growth_ = 103,      /* --param=inline-unit-growth= */
  OPT__param_integer_share_limit_ = 104,     /* --param=integer-share-limit= */
  OPT__param_ipa_cp_eval_threshold_ = 105,   /* --param=ipa-cp-eval-threshold= */
  OPT__param_ipa_cp_loop_hint_bonus_ = 106,  /* --param=ipa-cp-loop-hint-bonus= */
  OPT__param_ipa_cp_max_recursive_depth_ = 107,/* --param=ipa-cp-max-recursive-depth= */
  OPT__param_ipa_cp_min_recursive_probability_ = 108,/* --param=ipa-cp-min-recursive-probability= */
  OPT__param_ipa_cp_recursion_penalty_ = 109,/* --param=ipa-cp-recursion-penalty= */
  OPT__param_ipa_cp_single_call_penalty_ = 110,/* --param=ipa-cp-single-call-penalty= */
  OPT__param_ipa_cp_value_list_size_ = 111,  /* --param=ipa-cp-value-list-size= */
  OPT__param_ipa_max_aa_steps_ = 112,        /* --param=ipa-max-aa-steps= */
  OPT__param_ipa_max_agg_items_ = 113,       /* --param=ipa-max-agg-items= */
  OPT__param_ipa_max_param_expr_ops_ = 114,  /* --param=ipa-max-param-expr-ops= */
  OPT__param_ipa_max_switch_predicate_bounds_ = 115,/* --param=ipa-max-switch-predicate-bounds= */
  OPT__param_ipa_sra_max_replacements_ = 116,/* --param=ipa-sra-max-replacements= */
  OPT__param_ipa_sra_ptr_growth_factor_ = 117,/* --param=ipa-sra-ptr-growth-factor= */
  OPT__param_ipcp_unit_growth_ = 118,        /* --param=ipcp-unit-growth= */
  OPT__param_ira_loop_reserved_regs_ = 119,  /* --param=ira-loop-reserved-regs= */
  OPT__param_ira_max_conflict_table_size_ = 120,/* --param=ira-max-conflict-table-size= */
  OPT__param_ira_max_loops_num_ = 121,       /* --param=ira-max-loops-num= */
  OPT__param_iv_always_prune_cand_set_bound_ = 122,/* --param=iv-always-prune-cand-set-bound= */
  OPT__param_iv_consider_all_candidates_bound_ = 123,/* --param=iv-consider-all-candidates-bound= */
  OPT__param_iv_max_considered_uses_ = 124,  /* --param=iv-max-considered-uses= */
  OPT__param_jump_table_max_growth_ratio_for_size_ = 125,/* --param=jump-table-max-growth-ratio-for-size= */
  OPT__param_jump_table_max_growth_ratio_for_speed_ = 126,/* --param=jump-table-max-growth-ratio-for-speed= */
  OPT__param_l1_cache_line_size_ = 127,      /* --param=l1-cache-line-size= */
  OPT__param_l1_cache_size_ = 128,           /* --param=l1-cache-size= */
  OPT__param_l2_cache_size_ = 129,           /* --param=l2-cache-size= */
  OPT__param_large_function_growth_ = 130,   /* --param=large-function-growth= */
  OPT__param_large_function_insns_ = 131,    /* --param=large-function-insns= */
  OPT__param_large_stack_frame_growth_ = 132,/* --param=large-stack-frame-growth= */
  OPT__param_large_stack_frame_ = 133,       /* --param=large-stack-frame= */
  OPT__param_large_unit_insns_ = 134,        /* --param=large-unit-insns= */
  OPT__param_lim_expensive_ = 135,           /* --param=lim-expensive= */
  OPT__param_logical_op_non_short_circuit_ = 136,/* --param=logical-op-non-short-circuit= */
  OPT__param_loop_block_tile_size_ = 137,    /* --param=loop-block-tile-size= */
  OPT__param_loop_interchange_max_num_stmts_ = 138,/* --param=loop-interchange-max-num-stmts= */
  OPT__param_loop_interchange_stride_ratio_ = 139,/* --param=loop-interchange-stride-ratio= */
  OPT__param_loop_invariant_max_bbs_in_loop_ = 140,/* --param=loop-invariant-max-bbs-in-loop= */
  OPT__param_loop_max_datarefs_for_datadeps_ = 141,/* --param=loop-max-datarefs-for-datadeps= */
  OPT__param_loop_versioning_max_inner_insns_ = 142,/* --param=loop-versioning-max-inner-insns= */
  OPT__param_loop_versioning_max_outer_insns_ = 143,/* --param=loop-versioning-max-outer-insns= */
  OPT__param_lra_inheritance_ebb_probability_cutoff_ = 144,/* --param=lra-inheritance-ebb-probability-cutoff= */
  OPT__param_lra_max_considered_reload_pseudos_ = 145,/* --param=lra-max-considered-reload-pseudos= */
  OPT__param_lto_max_partition_ = 146,       /* --param=lto-max-partition= */
  OPT__param_lto_max_streaming_parallelism_ = 147,/* --param=lto-max-streaming-parallelism= */
  OPT__param_lto_min_partition_ = 148,       /* --param=lto-min-partition= */
  OPT__param_lto_partitions_ = 149,          /* --param=lto-partitions= */
  OPT__param_max_average_unrolled_insns_ = 150,/* --param=max-average-unrolled-insns= */
  OPT__param_max_combine_insns_ = 151,       /* --param=max-combine-insns= */
  OPT__param_max_completely_peel_loop_nest_depth_ = 152,/* --param=max-completely-peel-loop-nest-depth= */
  OPT__param_max_completely_peel_times_ = 153,/* --param=max-completely-peel-times= */
  OPT__param_max_completely_peeled_insns_ = 154,/* --param=max-completely-peeled-insns= */
  OPT__param_max_crossjump_edges_ = 155,     /* --param=max-crossjump-edges= */
  OPT__param_max_cse_insns_ = 156,           /* --param=max-cse-insns= */
  OPT__param_max_cse_path_length_ = 157,     /* --param=max-cse-path-length= */
  OPT__param_max_cselib_memory_locations_ = 158,/* --param=max-cselib-memory-locations= */
  OPT__param_max_debug_marker_count_ = 159,  /* --param=max-debug-marker-count= */
  OPT__param_max_delay_slot_insn_search_ = 160,/* --param=max-delay-slot-insn-search= */
  OPT__param_max_delay_slot_live_search_ = 161,/* --param=max-delay-slot-live-search= */
  OPT__param_max_dse_active_local_stores_ = 162,/* --param=max-dse-active-local-stores= */
  OPT__param_max_early_inliner_iterations_ = 163,/* --param=max-early-inliner-iterations= */
  OPT__param_max_fields_for_field_sensitive_ = 164,/* --param=max-fields-for-field-sensitive= */
  OPT__param_max_fsm_thread_length_ = 165,   /* --param=max-fsm-thread-length= */
  OPT__param_max_fsm_thread_path_insns_ = 166,/* --param=max-fsm-thread-path-insns= */
  OPT__param_max_fsm_thread_paths_ = 167,    /* --param=max-fsm-thread-paths= */
  OPT__param_max_gcse_insertion_ratio_ = 168,/* --param=max-gcse-insertion-ratio= */
  OPT__param_max_gcse_memory_ = 169,         /* --param=max-gcse-memory= */
  OPT__param_max_goto_duplication_insns_ = 170,/* --param=max-goto-duplication-insns= */
  OPT__param_max_grow_copy_bb_insns_ = 171,  /* --param=max-grow-copy-bb-insns= */
  OPT__param_max_hoist_depth_ = 172,         /* --param=max-hoist-depth= */
  OPT__param_max_inline_insns_auto_ = 173,   /* --param=max-inline-insns-auto= */
  OPT__param_max_inline_insns_recursive_auto_ = 174,/* --param=max-inline-insns-recursive-auto= */
  OPT__param_max_inline_insns_recursive_ = 175,/* --param=max-inline-insns-recursive= */
  OPT__param_max_inline_insns_single_ = 176, /* --param=max-inline-insns-single= */
  OPT__param_max_inline_insns_size_ = 177,   /* --param=max-inline-insns-size= */
  OPT__param_max_inline_insns_small_ = 178,  /* --param=max-inline-insns-small= */
  OPT__param_max_inline_recursive_depth_auto_ = 179,/* --param=max-inline-recursive-depth-auto= */
  OPT__param_max_inline_recursive_depth_ = 180,/* --param=max-inline-recursive-depth= */
  OPT__param_max_isl_operations_ = 181,      /* --param=max-isl-operations= */
  OPT__param_max_iterations_computation_cost_ = 182,/* --param=max-iterations-computation-cost= */
  OPT__param_max_iterations_to_track_ = 183, /* --param=max-iterations-to-track= */
  OPT__param_max_jump_thread_duplication_stmts_ = 184,/* --param=max-jump-thread-duplication-stmts= */
  OPT__param_max_last_value_rtl_ = 185,      /* --param=max-last-value-rtl= */
  OPT__param_max_loop_header_insns_ = 186,   /* --param=max-loop-header-insns= */
  OPT__param_max_modulo_backtrack_attempts_ = 187,/* --param=max-modulo-backtrack-attempts= */
  OPT__param_max_partial_antic_length_ = 188,/* --param=max-partial-antic-length= */
  OPT__param_max_peel_branches_ = 189,       /* --param=max-peel-branches= */
  OPT__param_max_peel_times_ = 190,          /* --param=max-peel-times= */
  OPT__param_max_peeled_insns_ = 191,        /* --param=max-peeled-insns= */
  OPT__param_max_pending_list_length_ = 192, /* --param=max-pending-list-length= */
  OPT__param_max_pipeline_region_blocks_ = 193,/* --param=max-pipeline-region-blocks= */
  OPT__param_max_pipeline_region_insns_ = 194,/* --param=max-pipeline-region-insns= */
  OPT__param_max_pow_sqrt_depth_ = 195,      /* --param=max-pow-sqrt-depth= */
  OPT__param_max_predicted_iterations_ = 196,/* --param=max-predicted-iterations= */
  OPT__param_max_reload_search_insns_ = 197, /* --param=max-reload-search-insns= */
  OPT__param_max_rtl_if_conversion_insns_ = 198,/* --param=max-rtl-if-conversion-insns= */
  OPT__param_max_rtl_if_conversion_predictable_cost_ = 199,/* --param=max-rtl-if-conversion-predictable-cost= */
  OPT__param_max_rtl_if_conversion_unpredictable_cost_ = 200,/* --param=max-rtl-if-conversion-unpredictable-cost= */
  OPT__param_max_sched_extend_regions_iters_ = 201,/* --param=max-sched-extend-regions-iters= */
  OPT__param_max_sched_insn_conflict_delay_ = 202,/* --param=max-sched-insn-conflict-delay= */
  OPT__param_max_sched_ready_insns_ = 203,   /* --param=max-sched-ready-insns= */
  OPT__param_max_sched_region_blocks_ = 204, /* --param=max-sched-region-blocks= */
  OPT__param_max_sched_region_insns_ = 205,  /* --param=max-sched-region-insns= */
  OPT__param_max_slsr_cand_scan_ = 206,      /* --param=max-slsr-cand-scan= */
  OPT__param_max_speculative_devirt_maydefs_ = 207,/* --param=max-speculative-devirt-maydefs= */
  OPT__param_max_ssa_name_query_depth_ = 208,/* --param=max-ssa-name-query-depth= */
  OPT__param_max_stores_to_merge_ = 209,     /* --param=max-stores-to-merge= */
  OPT__param_max_stores_to_sink_ = 210,      /* --param=max-stores-to-sink= */
  OPT__param_max_tail_merge_comparisons_ = 211,/* --param=max-tail-merge-comparisons= */
  OPT__param_max_tail_merge_iterations_ = 212,/* --param=max-tail-merge-iterations= */
  OPT__param_max_tracked_strlens_ = 213,     /* --param=max-tracked-strlens= */
  OPT__param_max_tree_if_conversion_phi_args_ = 214,/* --param=max-tree-if-conversion-phi-args= */
  OPT__param_max_unroll_times_ = 215,        /* --param=max-unroll-times= */
  OPT__param_max_unrolled_insns_ = 216,      /* --param=max-unrolled-insns= */
  OPT__param_max_unswitch_insns_ = 217,      /* --param=max-unswitch-insns= */
  OPT__param_max_unswitch_level_ = 218,      /* --param=max-unswitch-level= */
  OPT__param_max_variable_expansions_in_unroller_ = 219,/* --param=max-variable-expansions-in-unroller= */
  OPT__param_max_vartrack_expr_depth_ = 220, /* --param=max-vartrack-expr-depth= */
  OPT__param_max_vartrack_reverse_op_size_ = 221,/* --param=max-vartrack-reverse-op-size= */
  OPT__param_max_vartrack_size_ = 222,       /* --param=max-vartrack-size= */
  OPT__param_max_vrp_switch_assertions_ = 223,/* --param=max-vrp-switch-assertions= */
  OPT__param_min_crossjump_insns_ = 224,     /* --param=min-crossjump-insns= */
  OPT__param_min_inline_recursive_probability_ = 225,/* --param=min-inline-recursive-probability= */
  OPT__param_min_insn_to_prefetch_ratio_ = 226,/* --param=min-insn-to-prefetch-ratio= */
  OPT__param_min_loop_cond_split_prob_ = 227,/* --param=min-loop-cond-split-prob= */
  OPT__param_min_nondebug_insn_uid_ = 228,   /* --param=min-nondebug-insn-uid= */
  OPT__param_min_size_for_stack_sharing_ = 229,/* --param=min-size-for-stack-sharing= */
  OPT__param_min_spec_prob_ = 230,           /* --param=min-spec-prob= */
  OPT__param_min_vect_loop_bound_ = 231,     /* --param=min-vect-loop-bound= */
  OPT__param_parloops_chunk_size_ = 232,     /* --param=parloops-chunk-size= */
  OPT__param_parloops_min_per_thread_ = 233, /* --param=parloops-min-per-thread= */
  OPT__param_parloops_schedule_ = 234,       /* --param=parloops-schedule= */
  OPT__param_partial_inlining_entry_probability_ = 235,/* --param=partial-inlining-entry-probability= */
  OPT__param_predictable_branch_outcome_ = 236,/* --param=predictable-branch-outcome= */
  OPT__param_prefetch_dynamic_strides_ = 237,/* --param=prefetch-dynamic-strides= */
  OPT__param_prefetch_latency_ = 238,        /* --param=prefetch-latency= */
  OPT__param_prefetch_min_insn_to_mem_ratio_ = 239,/* --param=prefetch-min-insn-to-mem-ratio= */
  OPT__param_prefetch_minimum_stride_ = 240, /* --param=prefetch-minimum-stride= */
  OPT__param_profile_func_internal_id_ = 241,/* --param=profile-func-internal-id= */
  OPT__param_rpo_vn_max_loop_depth_ = 242,   /* --param=rpo-vn-max-loop-depth= */
  OPT__param_sccvn_max_alias_queries_per_access_ = 243,/* --param=sccvn-max-alias-queries-per-access= */
  OPT__param_scev_max_expr_complexity_ = 244,/* --param=scev-max-expr-complexity= */
  OPT__param_scev_max_expr_size_ = 245,      /* --param=scev-max-expr-size= */
  OPT__param_sched_autopref_queue_depth_ = 246,/* --param=sched-autopref-queue-depth= */
  OPT__param_sched_mem_true_dep_cost_ = 247, /* --param=sched-mem-true-dep-cost= */
  OPT__param_sched_pressure_algorithm_ = 248,/* --param=sched-pressure-algorithm= */
  OPT__param_sched_spec_prob_cutoff_ = 249,  /* --param=sched-spec-prob-cutoff= */
  OPT__param_sched_state_edge_prob_cutoff_ = 250,/* --param=sched-state-edge-prob-cutoff= */
  OPT__param_selsched_insns_to_rename_ = 251,/* --param=selsched-insns-to-rename= */
  OPT__param_selsched_max_lookahead_ = 252,  /* --param=selsched-max-lookahead= */
  OPT__param_selsched_max_sched_times_ = 253,/* --param=selsched-max-sched-times= */
  OPT__param_simultaneous_prefetches_ = 254, /* --param=simultaneous-prefetches= */
  OPT__param_sink_frequency_threshold_ = 255,/* --param=sink-frequency-threshold= */
  OPT__param_slp_max_insns_in_bb_ = 256,     /* --param=slp-max-insns-in-bb= */
  OPT__param_sms_dfa_history_ = 257,         /* --param=sms-dfa-history= */
  OPT__param_sms_loop_average_count_threshold_ = 258,/* --param=sms-loop-average-count-threshold= */
  OPT__param_sms_max_ii_factor_ = 259,       /* --param=sms-max-ii-factor= */
  OPT__param_sms_min_sc_ = 260,              /* --param=sms-min-sc= */
  OPT__param_sra_max_scalarization_size_Osize_ = 261,/* --param=sra-max-scalarization-size-Osize= */
  OPT__param_sra_max_scalarization_size_Ospeed_ = 262,/* --param=sra-max-scalarization-size-Ospeed= */
  OPT__param_ssa_name_def_chain_limit_ = 263,/* --param=ssa-name-def-chain-limit= */
  OPT__param_ssp_buffer_size_ = 264,         /* --param=ssp-buffer-size= */
  OPT__param_stack_clash_protection_guard_size_ = 265,/* --param=stack-clash-protection-guard-size= */
  OPT__param_stack_clash_protection_probe_interval_ = 266,/* --param=stack-clash-protection-probe-interval= */
  OPT__param_store_merging_allow_unaligned_ = 267,/* --param=store-merging-allow-unaligned= */
  OPT__param_store_merging_max_size_ = 268,  /* --param=store-merging-max-size= */
  OPT__param_switch_conversion_max_branch_ratio_ = 269,/* --param=switch-conversion-max-branch-ratio= */
  OPT__param_tm_max_aggregate_size_ = 270,   /* --param=tm-max-aggregate-size= */
  OPT__param_tracer_dynamic_coverage_feedback_ = 271,/* --param=tracer-dynamic-coverage-feedback= */
  OPT__param_tracer_dynamic_coverage_ = 272, /* --param=tracer-dynamic-coverage= */
  OPT__param_tracer_max_code_growth_ = 273,  /* --param=tracer-max-code-growth= */
  OPT__param_tracer_min_branch_probability_feedback_ = 274,/* --param=tracer-min-branch-probability-feedback= */
  OPT__param_tracer_min_branch_probability_ = 275,/* --param=tracer-min-branch-probability= */
  OPT__param_tracer_min_branch_ratio_ = 276, /* --param=tracer-min-branch-ratio= */
  OPT__param_tree_reassoc_width_ = 277,      /* --param=tree-reassoc-width= */
  OPT__param_uninit_control_dep_attempts_ = 278,/* --param=uninit-control-dep-attempts= */
  OPT__param_uninlined_function_insns_ = 279,/* --param=uninlined-function-insns= */
  OPT__param_uninlined_function_time_ = 280, /* --param=uninlined-function-time= */
  OPT__param_uninlined_thunk_insns_ = 281,   /* --param=uninlined-thunk-insns= */
  OPT__param_uninlined_thunk_time_ = 282,    /* --param=uninlined-thunk-time= */
  OPT__param_unlikely_bb_count_fraction_ = 283,/* --param=unlikely-bb-count-fraction= */
  OPT__param_unroll_jam_max_unroll_ = 284,   /* --param=unroll-jam-max-unroll= */
  OPT__param_unroll_jam_min_percent_ = 285,  /* --param=unroll-jam-min-percent= */
  OPT__param_use_after_scope_direct_emission_threshold_ = 286,/* --param=use-after-scope-direct-emission-threshold= */
  OPT__param_use_canonical_types_ = 287,     /* --param=use-canonical-types= */
  OPT__param_vect_epilogues_nomask_ = 288,   /* --param=vect-epilogues-nomask= */
  OPT__param_vect_max_peeling_for_alignment_ = 289,/* --param=vect-max-peeling-for-alignment= */
  OPT__param_vect_max_version_for_alias_checks_ = 290,/* --param=vect-max-version-for-alias-checks= */
  OPT__param_vect_max_version_for_alignment_checks_ = 291,/* --param=vect-max-version-for-alignment-checks= */
  /* OPT__pass_exit_codes = 292, */          /* --pass-exit-codes */
  /* OPT__pedantic = 293, */                 /* --pedantic */
  /* OPT__pedantic_errors = 294, */          /* --pedantic-errors */
  /* OPT__pie = 295, */                      /* --pie */
  /* OPT__pipe = 296, */                     /* --pipe */
  /* OPT__prefix = 297, */                   /* --prefix */
  /* OPT__prefix_ = 298, */                  /* --prefix= */
  /* OPT__preprocess = 299, */               /* --preprocess */
  /* OPT__print_file_name = 300, */          /* --print-file-name */
  /* OPT__print_file_name_ = 301, */         /* --print-file-name= */
  /* OPT__print_libgcc_file_name = 302, */   /* --print-libgcc-file-name */
  /* OPT__print_missing_file_dependencies = 303, *//* --print-missing-file-dependencies */
  /* OPT__print_multi_directory = 304, */    /* --print-multi-directory */
  /* OPT__print_multi_lib = 305, */          /* --print-multi-lib */
  /* OPT__print_multi_os_directory = 306, */ /* --print-multi-os-directory */
  /* OPT__print_multiarch = 307, */          /* --print-multiarch */
  /* OPT__print_prog_name = 308, */          /* --print-prog-name */
  /* OPT__print_prog_name_ = 309, */         /* --print-prog-name= */
  /* OPT__print_search_dirs = 310, */        /* --print-search-dirs */
  /* OPT__print_sysroot = 311, */            /* --print-sysroot */
  /* OPT__print_sysroot_headers_suffix = 312, *//* --print-sysroot-headers-suffix */
  /* OPT__profile = 313, */                  /* --profile */
  /* OPT__save_temps = 314, */               /* --save-temps */
  /* OPT__shared = 315, */                   /* --shared */
  /* OPT__specs = 316, */                    /* --specs */
  /* OPT__specs_ = 317, */                   /* --specs= */
  /* OPT__static = 318, */                   /* --static */
  /* OPT__static_pie = 319, */               /* --static-pie */
  /* OPT__symbolic = 320, */                 /* --symbolic */
  /* OPT__sysroot = 321, */                  /* --sysroot */
  OPT__sysroot_ = 322,                       /* --sysroot= */
  OPT__target_help = 323,                    /* --target-help */
  /* OPT__time = 324, */                     /* --time */
  /* OPT__trace_includes = 325, */           /* --trace-includes */
  /* OPT__traditional = 326, */              /* --traditional */
  /* OPT__traditional_cpp = 327, */          /* --traditional-cpp */
  /* OPT__trigraphs = 328, */                /* --trigraphs */
  /* OPT__undefine_macro = 329, */           /* --undefine-macro */
  /* OPT__undefine_macro_ = 330, */          /* --undefine-macro= */
  /* OPT__user_dependencies = 331, */        /* --user-dependencies */
  /* OPT__verbose = 332, */                  /* --verbose */
  OPT__version = 333,                        /* --version */
  /* OPT__write_dependencies = 334, */       /* --write-dependencies */
  /* OPT__write_user_dependencies = 335, */  /* --write-user-dependencies */
  OPT_A = 336,                               /* -A */
  OPT_B = 337,                               /* -B */
  OPT_C = 338,                               /* -C */
  OPT_CC = 339,                              /* -CC */
  ...
  OPT_Tbss_ = 371,                           /* -Tbss= */
  OPT_Tdata = 372,                           /* -Tdata */
  OPT_Tdata_ = 373,                          /* -Tdata= */
  OPT_Ttext = 374,                           /* -Ttext */
  OPT_Ttext_ = 375,                          /* -Ttext= */
  OPT_U = 376,                               /* -U */
  /* OPT_W = 377, */                         /* -W */
  OPT_Wa_ = 378,                             /* -Wa, */
  OPT_Wabi = 379,                            /* -Wabi */
  OPT_Wabi_tag = 380,                        /* -Wabi-tag */
  OPT_Wabi_ = 381,                           /* -Wabi= */
  OPT_Wabsolute_value = 382,                 /* -Wabsolute-value */
  OPT_Waddress = 383,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 384,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 385,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 386,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 387,                       /* -Waliasing */
  OPT_Walign_commons = 388,                  /* -Walign-commons */
  /* OPT_Waligned_new = 389, */              /* -Waligned-new */
  OPT_Waligned_new_ = 390,                   /* -Waligned-new= */
  OPT_Wall = 391,                            /* -Wall */
  OPT_Walloc_size_larger_than_ = 392,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 393,                     /* -Walloc-zero */
  OPT_Walloca = 394,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 395,            /* -Walloca-larger-than= */
  OPT_Wampersand = 396,                      /* -Wampersand */
  OPT_Wargument_mismatch = 397,              /* -Wargument-mismatch */
  OPT_Warray_bounds = 398,                   /* -Warray-bounds */
  OPT_Warray_bounds_ = 399,                  /* -Warray-bounds= */
  OPT_Warray_temporaries = 400,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 401,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 402, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 403,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 404,              /* -Wattribute-warning */
  OPT_Wattributes = 405,                     /* -Wattributes */
  OPT_Wbad_function_cast = 406,              /* -Wbad-function-cast */
  OPT_Wbool_compare = 407,                   /* -Wbool-compare */
  OPT_Wbool_operation = 408,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 409,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 410,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 411,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 412, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 413,                   /* -Wc++11-compat */
  OPT_Wc__14_compat = 414,                   /* -Wc++14-compat */
  OPT_Wc__17_compat = 415,                   /* -Wc++17-compat */
  /* OPT_Wc__1z_compat = 416, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 417,                   /* -Wc++20-compat */
  /* OPT_Wc__2a_compat = 418, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 419,                 /* -Wc-binding-type */
  OPT_Wc11_c2x_compat = 420,                 /* -Wc11-c2x-compat */
  OPT_Wc90_c99_compat = 421,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 422,                 /* -Wc99-c11-compat */
  OPT_Wcannot_profile = 423,                 /* -Wcannot-profile */
  OPT_Wcast_align = 424,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 425,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 426,             /* -Wcast-function-type */
  OPT_Wcast_qual = 427,                      /* -Wcast-qual */
  OPT_Wcast_result = 428,                    /* -Wcast-result */
  /* OPT_Wcatch_value = 429, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 430,                   /* -Wcatch-value= */
  OPT_Wchar_subscripts = 431,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 432,           /* -Wcharacter-truncation */
  OPT_Wchkp = 433,                           /* -Wchkp */
  OPT_Wclass_conversion = 434,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 435,                /* -Wclass-memaccess */
  OPT_Wclobbered = 436,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 437,                /* -Wcomma-subscript */
  OPT_Wcomment = 438,                        /* -Wcomment */
  /* OPT_Wcomments = 439, */                 /* -Wcomments */
  OPT_Wcompare_reals = 440,                  /* -Wcompare-reals */
  OPT_Wconditionally_supported = 441,        /* -Wconditionally-supported */
  OPT_Wconversion = 442,                     /* -Wconversion */
  OPT_Wconversion_extra = 443,               /* -Wconversion-extra */
  OPT_Wconversion_null = 444,                /* -Wconversion-null */
  OPT_Wcoverage_mismatch = 445,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 446,                            /* -Wcpp */
  OPT_Wctor_dtor_privacy = 447,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 448,                  /* -Wdangling-else */
  OPT_Wdate_time = 449,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 450,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 451,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 452,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 453,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 454,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 455,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 456,        /* -Wdeprecated-declarations */
  OPT_Wdesignated_init = 457,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 458,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 459,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 460,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 461,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 462,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 463,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 464,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 465,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 466,                /* -Wduplicated-cond */
  OPT_Weffc__ = 467,                         /* -Weffc++ */
  OPT_Wempty_body = 468,                     /* -Wempty-body */
  OPT_Wendif_labels = 469,                   /* -Wendif-labels */
  OPT_Wenum_compare = 470,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 471,                /* -Wenum-conversion */
  OPT_Werror = 472,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 473, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 474,                         /* -Werror= */
  OPT_Wexpansion_to_defined = 475,           /* -Wexpansion-to-defined */
  OPT_Wextra = 476,                          /* -Wextra */
  OPT_Wextra_semi = 477,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 478,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 479,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 480,                    /* -Wfloat-equal */
  /* OPT_Wformat = 481, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 482,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 483,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 484,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 485,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 486, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 487,               /* -Wformat-overflow= */
  OPT_Wformat_security = 488,                /* -Wformat-security */
  OPT_Wformat_signedness = 489,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 490, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 491,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 492,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 493,             /* -Wformat-zero-length */
  OPT_Wformat_ = 494,                        /* -Wformat= */
  OPT_Wframe_address = 495,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 496,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 497,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 498,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 499,           /* -Wfunction-elimination */
  OPT_Whsa = 500,                            /* -Whsa */
  OPT_Wif_not_aligned = 501,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 502,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 503,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 504,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 505, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 506,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 507,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 508,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 509,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 510,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 511, */                   /* -Wimport */
  OPT_Winaccessible_base = 512,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 513,     /* -Wincompatible-pointer-types */
  OPT_Winherited_variadic_ctor = 514,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 515,             /* -Winit-list-lifetime */
  OPT_Winit_self = 516,                      /* -Winit-self */
  OPT_Winline = 517,                         /* -Winline */
  OPT_Wint_conversion = 518,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 519,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 520,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 521,               /* -Winteger-division */
  OPT_Wintrinsic_shadow = 522,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 523,                 /* -Wintrinsics-std */
  OPT_Winvalid_memory_model = 524,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 525,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 526,                    /* -Winvalid-pch */
  OPT_Wjump_misses_init = 527,               /* -Wjump-misses-init */
  OPT_Wl_ = 528,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 529, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 530,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 531,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 532,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 533,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 534,                     /* -Wlogical-op */
  OPT_Wlong_long = 535,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 536,              /* -Wlto-type-mismatch */
  OPT_Wmain = 537,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 538,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 539,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 540,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 541,         /* -Wmisleading-indentation */
  OPT_Wmismatched_tags = 542,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 543,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 544,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 545,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 546,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 547, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 548,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 549, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 550,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 551,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 552,             /* -Wmissing-prototypes */
  OPT_Wmudflap = 553,                        /* -Wmudflap */
  OPT_Wmultichar = 554,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 555,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 556,          /* -Wmultistatement-macros */
  OPT_Wnamespaces = 557,                     /* -Wnamespaces */
  OPT_Wnarrowing = 558,                      /* -Wnarrowing */
  OPT_Wnested_externs = 559,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 560, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 561, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_vla_larger_than = 562, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 563,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 564,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 565,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 566,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 567,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 568,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 569, */               /* -Wnormalized */
  OPT_Wnormalized_ = 570,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 571,               /* -Wnull-dereference */
  OPT_Wodr = 572,                            /* -Wodr */
  OPT_Wold_style_cast = 573,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 574,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 575,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 576,                    /* -Wopenmp-simd */
  OPT_Woverflow = 577,                       /* -Woverflow */
  OPT_Woverlength_strings = 578,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 579,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 580,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 581,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 582,            /* -Woverwrite-recursive */
  OPT_Wp_ = 583,                             /* -Wp, */
  OPT_Wpacked = 584,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 585,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 586,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 587,                         /* -Wpadded */
  OPT_Wparentheses = 588,                    /* -Wparentheses */
  OPT_Wpedantic = 589,                       /* -Wpedantic */
  OPT_Wpessimizing_move = 590,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 591, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 592,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 593,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 594,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 595,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 596,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 597,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 598,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 599,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 600,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 601,                       /* -Wprotocol */
  OPT_Wpsabi = 602,                          /* -Wpsabi */
  OPT_Wreal_q_constant = 603,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 604,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 605,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 606,                /* -Wredundant-decls */
  OPT_Wredundant_move = 607,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 608,                 /* -Wredundant-tags */
  OPT_Wregister = 609,                       /* -Wregister */
  OPT_Wreorder = 610,                        /* -Wreorder */
  OPT_Wrestrict = 611,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 612,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 613,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 614,           /* -Wscalar-storage-order */
  OPT_Wselector = 615,                       /* -Wselector */
  OPT_Wsequence_point = 616,                 /* -Wsequence-point */
  OPT_Wshadow = 617,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 618, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 619,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 620, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 621,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 622, */            /* -Wshadow=global */
  OPT_Wshadow_local = 623,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 624,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 625,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 626,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 627, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 628,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 629,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 630,                /* -Wsign-conversion */
  OPT_Wsign_promo = 631,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 632,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 633,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_div = 634,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 635,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 636,                    /* -Wspeculative */
  OPT_Wstack_protector = 637,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 638,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 639,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 640,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 641,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 642,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 643,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 644,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 645,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 646,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 647, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 648,             /* -Wstringop-overflow= */
  OPT_Wstringop_truncation = 649,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 650,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 651,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 652,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 653,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 654,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 655,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 656,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 657,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 658,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 659,               /* -Wsuggest-override */
  OPT_Wsurprising = 660,                     /* -Wsurprising */
  OPT_Wswitch = 661,                         /* -Wswitch */
  OPT_Wswitch_bool = 662,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 663,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 664,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 665,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 666,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 667,                      /* -Wsync-nand */
  OPT_Wsynth = 668,                          /* -Wsynth */
  OPT_Wsystem_headers = 669,                 /* -Wsystem-headers */
  OPT_Wtabs = 670,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 671,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 672,           /* -Wtautological-compare */
  OPT_Wtemplates = 673,                      /* -Wtemplates */
  OPT_Wterminate = 674,                      /* -Wterminate */
  OPT_Wtraditional = 675,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 676,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 677,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 678,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 679,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 680,            /* -Wundeclared-selector */
  OPT_Wundef = 681,                          /* -Wundef */
  OPT_Wundefined_do_loop = 682,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 683,                      /* -Wunderflow */
  OPT_Wuninitialized = 684,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 685,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 686, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 687, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 688,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 689,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 690,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 691,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 692, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 693,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 694,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 695,                /* -Wunused-function */
  OPT_Wunused_label = 696,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 697,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 698,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 699,               /* -Wunused-parameter */
  OPT_Wunused_result = 700,                  /* -Wunused-result */
  OPT_Wunused_value = 701,                   /* -Wunused-value */
  OPT_Wunused_variable = 702,                /* -Wunused-variable */
  OPT_Wuse_without_only = 703,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 704,                   /* -Wuseless-cast */
  OPT_Wvarargs = 705,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 706,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 707,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 708,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 709,            /* -Wvirtual-move-assign */
  OPT_Wvla = 710,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 711,               /* -Wvla-larger-than= */
  OPT_Wvolatile = 712,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 713,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 714,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 715,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 716,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 717,                       /* -Wzerotrip */
  OPT_X = 718,                               /* -X */
  OPT_Xassembler = 719,                      /* -Xassembler */
  OPT_Xf = 720,                              /* -Xf */
  OPT_Xlinker = 721,                         /* -Xlinker */
  OPT_Xpreprocessor = 722,                   /* -Xpreprocessor */
  OPT_Z = 723,                               /* -Z */
  OPT_ansi = 724,                            /* -ansi */
  OPT_aux_info = 725,                        /* -aux-info */
  /* OPT_aux_info_ = 726, */                 /* -aux-info= */
  OPT_auxbase = 727,                         /* -auxbase */
  OPT_auxbase_strip = 728,                   /* -auxbase-strip */
  OPT_c = 729,                               /* -c */
  OPT_callgraph = 730,                       /* -callgraph */
  OPT_coverage = 731,                        /* -coverage */
  OPT_cpp = 732,                             /* -cpp */
  OPT_cpp_ = 733,                            /* -cpp= */
  OPT_d = 734,                               /* -d */
  OPT_debuglib_ = 735,                       /* -debuglib= */
  OPT_defaultlib_ = 736,                     /* -defaultlib= */
  OPT_defined_only = 737,                    /* -defined-only */
  OPT_demangle = 738,                        /* -demangle */
  OPT_dstartfiles = 739,                     /* -dstartfiles */
  OPT_dump_body_ = 740,                      /* -dump-body= */
  OPT_dump_level_ = 741,                     /* -dump-level= */
  OPT_dumpbase = 742,                        /* -dumpbase */
  OPT_dumpdir = 743,                         /* -dumpdir */
  OPT_dumpfullversion = 744,                 /* -dumpfullversion */
  OPT_dumpmachine = 745,                     /* -dumpmachine */
  OPT_dumpspecs = 746,                       /* -dumpspecs */
  OPT_dumpversion = 747,                     /* -dumpversion */
  OPT_e = 748,                               /* -e */
  OPT_export_dynamic = 749,                  /* -export-dynamic */
  OPT_fPIC = 750,                            /* -fPIC */
  OPT_fPIE = 751,                            /* -fPIE */
  OPT_fRTS_ = 752,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 753,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 754,                   /* -fabi-version= */
  OPT_faccess_control = 755,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 756,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 757,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 758,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 759,                  /* -falign-commons */
  OPT_falign_functions = 760,                /* -falign-functions */
  OPT_falign_functions_ = 761,               /* -falign-functions= */
  OPT_falign_jumps = 762,                    /* -falign-jumps */
  OPT_falign_jumps_ = 763,                   /* -falign-jumps= */
  OPT_falign_labels = 764,                   /* -falign-labels */
  OPT_falign_labels_ = 765,                  /* -falign-labels= */
  OPT_falign_loops = 766,                    /* -falign-loops */
  OPT_falign_loops_ = 767,                   /* -falign-loops= */
  /* OPT_faligned_new = 768, */              /* -faligned-new */
  OPT_faligned_new_ = 769,                   /* -faligned-new= */
  OPT_fall_instantiations = 770,             /* -fall-instantiations */
  OPT_fall_intrinsics = 771,                 /* -fall-intrinsics */
  OPT_fall_virtual = 772,                    /* -fall-virtual */
  OPT_fallocation_dce = 773,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 774,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 775,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 776,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 777,/* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 778,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 779,         /* -falt-external-templates */
  /* OPT_fargument_alias = 780, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 781, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 782, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 783, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 784,            /* -fasan-shadow-offset= */
  OPT_fasm = 785,                            /* -fasm */
  OPT_fassert = 786,                         /* -fassert */
  OPT_fassociative_math = 787,               /* -fassociative-math */
  OPT_fassume_phsa = 788,                    /* -fassume-phsa */
  OPT_fasynchronous_unwind_tables = 789,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 790,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 791,                   /* -fauto-profile */
  OPT_fauto_profile_ = 792,                  /* -fauto-profile= */
  OPT_fautomatic = 793,                      /* -fautomatic */
  OPT_fbackslash = 794,                      /* -fbackslash */
  OPT_fbacktrace = 795,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 796,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 797,                   /* -fbounds-check */
  OPT_fbounds_check_ = 798,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 799,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 800,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 801, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 802, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 803, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 804,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 805,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 806,                        /* -fbuiltin */
  OPT_fbuiltin_ = 807,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 808,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 809,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 810,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 811,                    /* -fcall-saved- */
  OPT_fcall_used_ = 812,                     /* -fcall-used- */
  OPT_fcaller_saves = 813,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 814,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 815,                /* -fcallgraph-info= */
  OPT_fcanonical_system_headers = 816,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 817, */            /* -fcf-protection */
  OPT_fcf_protection_ = 818,                 /* -fcf-protection= */
  OPT_fchar8_t = 819,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 820,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 821, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 822,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 823,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 824,                         /* -fcheck= */
  OPT_fchecking = 825,                       /* -fchecking */
  OPT_fchecking_ = 826,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 827,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 828,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 829,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 830,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 831,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 832,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 833,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 834,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 835, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 836,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 837,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 838,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 839, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 840,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 841,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 842,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 843,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 844,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 845, */                 /* -fcilkplus */
  OPT_fcoarray_ = 846,                       /* -fcoarray= */
  OPT_fcode_hoisting = 847,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 848,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 849,                         /* -fcommon */
  OPT_fcompare_debug = 850,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 851,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 852,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 853,                   /* -fcompare-elim */
  OPT_fconcepts = 854,                       /* -fconcepts */
  OPT_fconcepts_ts = 855,                    /* -fconcepts-ts */
  OPT_fcond_mismatch = 856,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 857, */           /* -fconserve-space */
  OPT_fconserve_stack = 858,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 859,         /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 860,         /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 861,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 862,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 863,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 864,                       /* -fconvert= */
  OPT_fcprop_registers = 865,                /* -fcprop-registers */
  OPT_fcray_pointer = 866,                   /* -fcray-pointer */
  OPT_fcrossjumping = 867,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 868,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 869, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 870,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 871,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 872,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 873,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 874,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 875,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 876,                       /* -fdbg-cnt= */
  OPT_fdce = 877,                            /* -fdce */
  OPT_fdebug = 878,                          /* -fdebug */
  OPT_fdebug_cpp = 879,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 880,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 881,            /* -fdebug-types-section */
  OPT_fdebug_ = 882,                         /* -fdebug= */
  OPT_fdec = 883,                            /* -fdec */
  OPT_fdec_blank_format_item = 884,          /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 885,           /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 886,            /* -fdec-format-defaults */
  OPT_fdec_include = 887,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 888,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 889,                       /* -fdec-math */
  OPT_fdec_static = 890,                     /* -fdec-static */
  OPT_fdec_structure = 891,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 892,              /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 893, */         /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 894,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 895, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 896,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 897,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 898,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 899,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 900,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 901,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 902,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 903,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 904,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 905,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 906,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 907, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 908,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_format_ = 909,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 910,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 911,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 912,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 913,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 914,           /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 915,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 916,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 917,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 918,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 919, /* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 920,              /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 921,                /* -fdirectives-only */
  OPT_fdisable_ = 922,                       /* -fdisable- */
  OPT_fdoc = 923,                            /* -fdoc */
  OPT_fdoc_dir_ = 924,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 925,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 926,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 927,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 928,         /* -fdollars-in-identifiers */
  OPT_fdruntime = 929,                       /* -fdruntime */
  OPT_fdse = 930,                            /* -fdse */
  OPT_fdump_ = 931,                          /* -fdump- */
  OPT_fdump_ada_spec = 932,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 933,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 934, */                /* -fdump-core */
  OPT_fdump_d_original = 935,                /* -fdump-d-original */
  OPT_fdump_final_insns = 936,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 937,              /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 938,            /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 939,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 940,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 941,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 942,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 943,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 944, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 945,                    /* -fdump-passes */
  OPT_fdump_scos = 946,                      /* -fdump-scos */
  OPT_fdump_unnumbered = 947,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 948,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 949,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 950,                 /* -fearly-inlining */
  OPT_felide_constructors = 951,             /* -felide-constructors */
  OPT_felide_type = 952,                     /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 953, */    /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 954, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 955,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 956,        /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 957,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 958,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 959,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 960,                        /* -fenable- */
  OPT_fenforce_eh_specs = 961,               /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 962,                 /* -fenum-int-equiv */
  OPT_fexceptions = 963,                     /* -fexceptions */
  OPT_fexcess_precision_ = 964,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 965,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 966,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 967,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 968,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 969,                /* -fextern-tls-init */
  OPT_fexternal_blas = 970,                  /* -fexternal-blas */
  OPT_fexternal_templates = 971,             /* -fexternal-templates */
  OPT_ff2c = 972,                            /* -ff2c */
  OPT_ffast_math = 973,                      /* -ffast-math */
  OPT_ffat_lto_objects = 974,                /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 975,               /* -ffile-prefix-map= */
  OPT_ffinite_loops = 976,                   /* -ffinite-loops */
  OPT_ffinite_math_only = 977,               /* -ffinite-math-only */
  OPT_ffixed_ = 978,                         /* -ffixed- */
  OPT_ffixed_form = 979,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 980,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 981,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 982,                    /* -ffloat-store */
  OPT_ffor_scope = 983,                      /* -ffor-scope */
  /* OPT_fforce_addr = 984, */               /* -fforce-addr */
  OPT_fforward_propagate = 985,              /* -fforward-propagate */
  OPT_ffp_contract_ = 986,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 987,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 988,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 989,                      /* -ffpe-trap= */
  OPT_ffree_form = 990,                      /* -ffree-form */
  OPT_ffree_line_length_ = 991,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 992,          /* -ffree-line-length-none */
  OPT_ffreestanding = 993,                   /* -ffreestanding */
  OPT_ffriend_injection = 994,               /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 995,      /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 996,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 997,                   /* -ffunction-cse */
  OPT_ffunction_sections = 998,              /* -ffunction-sections */
  OPT_fgcse = 999,                           /* -fgcse */
  OPT_fgcse_after_reload = 1000,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1001,                      /* -fgcse-las */
  OPT_fgcse_lm = 1002,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1003,                       /* -fgcse-sm */
  OPT_fgimple = 1004,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1005,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1006,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1007,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1008,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1009,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1010,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1011,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1012,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1013,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1014,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1015,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1016,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1017,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1018,                      /* -fgo-dump- */
  OPT_fgo_optimize_ = 1019,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1020,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1021,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1022,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1023,                      /* -fgraphite */
  OPT_fgraphite_identity = 1024,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1025,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1026,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1027, */       /* -fhandle-exceptions */
  /* OPT_fhelp = 1028, */                    /* -fhelp */
  /* OPT_fhelp_ = 1029, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1030,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1031,                     /* -fhonor-std */
  OPT_fhosted = 1032,                        /* -fhosted */
  OPT_fhuge_objects = 1033,                  /* -fhuge-objects */
  OPT_fident = 1034,                         /* -fident */
  OPT_fif_conversion = 1035,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1036,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1037,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1038,             /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 1039,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1040,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1041,            /* -fimplicit-templates */
  OPT_findirect_inlining = 1042,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1043,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1044,               /* -finit-character= */
  OPT_finit_derived = 1045,                  /* -finit-derived */
  OPT_finit_integer_ = 1046,                 /* -finit-integer= */
  OPT_finit_local_zero = 1047,               /* -finit-local-zero */
  OPT_finit_logical_ = 1048,                 /* -finit-logical= */
  OPT_finit_real_ = 1049,                    /* -finit-real= */
  OPT_finline = 1050,                        /* -finline */
  OPT_finline_arg_packing = 1051,            /* -finline-arg-packing */
  OPT_finline_atomics = 1052,                /* -finline-atomics */
  OPT_finline_functions = 1053,              /* -finline-functions */
  OPT_finline_functions_called_once = 1054,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1055, */           /* -finline-limit- */
  OPT_finline_limit_ = 1056,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1057,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1058,        /* -finline-small-functions */
  OPT_finput_charset_ = 1059,                /* -finput-charset= */
  OPT_finstrument_functions = 1060,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1061,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1062,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 1063,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1064,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1065,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1066,                    /* -finvariants */
  OPT_fipa_bit_cp = 1067,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1068,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1069, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1070,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1071,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1072,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1073,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1074, */        /* -fipa-matrix-reorg */
  OPT_fipa_profile = 1075,                   /* -fipa-profile */
  OPT_fipa_pta = 1076,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1077,                /* -fipa-pure-const */
  OPT_fipa_ra = 1078,                        /* -fipa-ra */
  OPT_fipa_reference = 1079,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1080,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1081,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1082,           /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 1083, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1084,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1085,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1086,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1087,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1088,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1089,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1090,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1091,                  /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 1092,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1093,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1094,              /* -fivar-visibility= */
  OPT_fivopts = 1095,                        /* -fivopts */
  OPT_fjump_tables = 1096,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1097,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1098,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1099,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1100,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1101,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1102,                     /* -flabels-ok */
  OPT_flax_vector_conversions = 1103,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1104,            /* -fleading-underscore */
  OPT_flifetime_dse = 1105,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1106,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1107,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1108,                /* -flinker-output= */
  /* OPT_flive_patching = 1109, */           /* -flive-patching */
  OPT_flive_patching_ = 1110,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1111,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1112,                   /* -flocal-ivars */
  /* OPT_floop_block = 1113, */              /* -floop-block */
  /* OPT_floop_flatten = 1114, */            /* -floop-flatten */
  OPT_floop_interchange = 1115,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1116,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1117, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1118,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1119, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1120,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1121,                     /* -flra-remat */
  OPT_flto = 1122,                           /* -flto */
  OPT_flto_compression_level_ = 1123,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1124, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1125,                /* -flto-partition= */
  OPT_flto_report = 1126,                    /* -flto-report */
  OPT_flto_report_wpa = 1127,                /* -flto-report-wpa */
  OPT_flto_ = 1128,                          /* -flto= */
  OPT_fltrans = 1129,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1130,           /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 1131,             /* -fmacro-prefix-map= */
  OPT_fmain = 1132,                          /* -fmain */
  OPT_fmath_errno = 1133,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1134,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1135,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1136,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1137,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1138,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1139,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1140,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1141,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1142,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1143,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1144,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1145,               /* -fmessage-length= */
  OPT_fmodule_file_ = 1146,                  /* -fmodule-file= */
  OPT_fmodule_private = 1147,                /* -fmodule-private */
  OPT_fmoduleinfo = 1148,                    /* -fmoduleinfo */
  OPT_fmodulo_sched = 1149,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1150,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1151,          /* -fmove-loop-invariants */
  OPT_fms_extensions = 1152,                 /* -fms-extensions */
  OPT_fmudflap = 1153,                       /* -fmudflap */
  OPT_fmudflapir = 1154,                     /* -fmudflapir */
  OPT_fmudflapth = 1155,                     /* -fmudflapth */
  OPT_fname_mangling_version_ = 1156,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1157,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1158,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1159,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1160,                  /* -fnext-runtime */
  OPT_fnil_receivers = 1161,                 /* -fnil-receivers */
  OPT_fnon_call_exceptions = 1162,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1163,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1164,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1165,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1166,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1167,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1168,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1169,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1170,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1171,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1172,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1173,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1174,                  /* -foffload-abi= */
  OPT_foffload_ = 1175,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1176,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1177,                         /* -fonly= */
  OPT_fopenacc = 1178,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1179,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1180,                        /* -fopenmp */
  OPT_fopenmp_simd = 1181,                   /* -fopenmp-simd */
  OPT_foperator_names = 1182,                /* -foperator-names */
  OPT_fopt_info = 1183,                      /* -fopt-info */
  OPT_fopt_info_ = 1184,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1185, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1186,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1187,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1188, */          /* -foptional-diags */
  OPT_fpack_derived = 1189,                  /* -fpack-derived */
  OPT_fpack_struct = 1190,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1191,                  /* -fpack-struct= */
  OPT_fpad_source = 1192,                    /* -fpad-source */
  OPT_fpartial_inlining = 1193,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1194,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1195,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1196,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1197,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1198,                    /* -fpeel-loops */
  OPT_fpeephole = 1199,                      /* -fpeephole */
  OPT_fpeephole2 = 1200,                     /* -fpeephole2 */
  OPT_fpermissive = 1201,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1202,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1203,                           /* -fpic */
  OPT_fpie = 1204,                           /* -fpie */
  OPT_fplan9_extensions = 1205,              /* -fplan9-extensions */
  OPT_fplt = 1206,                           /* -fplt */
  OPT_fplugin_arg_ = 1207,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1208,                       /* -fplugin= */
  OPT_fpost_ipa_mem_report = 1209,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1210,                /* -fpostconditions */
  OPT_fpre_include_ = 1211,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1212,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1213,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1214,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1215,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1216,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1217,              /* -fpretty-templates */
  OPT_fprintf_return_value = 1218,           /* -fprintf-return-value */
  OPT_fprofile = 1219,                       /* -fprofile */
  OPT_fprofile_abs_path = 1220,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1221,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1222,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1223,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1224,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1225,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1226,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1227,             /* -fprofile-generate= */
  OPT_fprofile_note_ = 1228,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1229,      /* -fprofile-partial-training */
  OPT_fprofile_reorder_functions = 1230,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1231,                /* -fprofile-report */
  OPT_fprofile_update_ = 1232,               /* -fprofile-update= */
  OPT_fprofile_use = 1233,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1234,                  /* -fprofile-use= */
  OPT_fprofile_values = 1235,                /* -fprofile-values */
  OPT_fprotect_parens = 1236,                /* -fprotect-parens */
  OPT_frandom_seed = 1237,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1238,                  /* -frandom-seed= */
  OPT_frange_check = 1239,                   /* -frange-check */
  OPT_freal_4_real_10 = 1240,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1241,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1242,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1243,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1244,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1245,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1246,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1247,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1248,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1249,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1250,               /* -frecord-marker=8 */
  OPT_frecursive = 1251,                     /* -frecursive */
  OPT_free = 1252,                           /* -free */
  OPT_freg_struct_return = 1253,             /* -freg-struct-return */
  /* OPT_fregmove = 1254, */                 /* -fregmove */
  OPT_frelease = 1255,                       /* -frelease */
  OPT_frename_registers = 1256,              /* -frename-registers */
  OPT_freorder_blocks = 1257,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1258,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1259,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1260,             /* -freorder-functions */
  OPT_frepack_arrays = 1261,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1262,          /* -freplace-objc-classes */
  OPT_frepo = 1263,                          /* -frepo */
  OPT_freport_bug = 1264,                    /* -freport-bug */
  OPT_frequire_return_statement = 1265,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1266,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1267, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1268,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1269,                   /* -fresolution= */
  OPT_frounding_math = 1270,                 /* -frounding-math */
  OPT_frtti = 1271,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1272,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1273,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1274,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1275,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1276,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1277,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1278,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1279,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1280, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1281,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1282,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1283,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1284,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1285,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1286,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1287,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1288,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1289,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1290,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1291,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1292,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1293,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1294,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1295,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1296,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1297, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1298,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1299,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1300,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1301,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1302,               /* -fsection-anchors */
  /* OPT_fsee = 1303, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1304,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1305,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1306,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1307,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1308,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1309,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1310,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1311,                   /* -fshort-enums */
  OPT_fshort_wchar = 1312,                   /* -fshort-wchar */
  OPT_fshow_column = 1313,                   /* -fshow-column */
  OPT_fshrink_wrap = 1314,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1315,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1316,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1317,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1318,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1319,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1320,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1321,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1322,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1323,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1324,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1325,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1326,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1327,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1328,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1329,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1330,                      /* -fsquangle */
  OPT_fssa_backprop = 1331,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1332,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1333,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1334,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1335, */             /* -fstack-check */
  OPT_fstack_check_ = 1336,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1337,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1338,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1339,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1340,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1341,               /* -fstack-protector */
  OPT_fstack_protector_all = 1342,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1343,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1344,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1345,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1346,                   /* -fstack-usage */
  OPT_fstats = 1347,                         /* -fstats */
  OPT_fstdarg_opt = 1348,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1349,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1350, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1351,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1352,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1353,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1354,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1355,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1356, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1357,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1358,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1359,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1360,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1361,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1362, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1363,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1364, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1365,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1366, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1367,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1368,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1369,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1370,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1371,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1372,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1373,                   /* -ftime-report */
  OPT_ftime_report_details = 1374,           /* -ftime-report-details */
  OPT_ftls_model_ = 1375,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1376,              /* -ftoplevel-reorder */
  OPT_ftracer = 1377,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1378,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1379,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1380,                   /* -ftrampolines */
  OPT_ftransition_all = 1381,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1382,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1383,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1384,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1385,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1386,              /* -ftransition=field */
  OPT_ftransition_import = 1387,             /* -ftransition=import */
  OPT_ftransition_nogc = 1388,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1389,                /* -ftransition=tls */
  OPT_ftrapping_math = 1390,                 /* -ftrapping-math */
  OPT_ftrapv = 1391,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1392,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1393,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1394,                      /* -ftree-ccp */
  OPT_ftree_ch = 1395,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1396, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1397,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1398,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1399, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1400,                   /* -ftree-cselim */
  OPT_ftree_dce = 1401,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1402,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1403,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1404,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1405,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1406, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1407,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1408,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1409, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1410,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1411,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1412, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1413,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1414,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1415,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1416,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1417,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1418,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1419,                      /* -ftree-pre */
  OPT_ftree_pta = 1420,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1421,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1422, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1423,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1424,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1425,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1426,                     /* -ftree-slsr */
  OPT_ftree_sra = 1427,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1428, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1429, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1430,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1431,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1432,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1433, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1434,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1435, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1436,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1437,         /* -funconstrained-commons */
  OPT_funderscoring = 1438,                  /* -funderscoring */
  OPT_funit_at_a_time = 1439,                /* -funit-at-a-time */
  OPT_funittest = 1440,                      /* -funittest */
  OPT_funroll_all_loops = 1441,              /* -funroll-all-loops */
  OPT_funroll_loops = 1442,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1443, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1444,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1445,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1446,                 /* -funsigned-char */
  OPT_funswitch_loops = 1447,                /* -funswitch-loops */
  OPT_funwind_tables = 1448,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1449,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1450,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1451,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1452,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1453,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1454,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1455,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1456,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1457,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1458,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1459,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1460, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1461,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1462,                   /* -fverbose-asm */
  /* OPT_fversion = 1463, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1464,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1465,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1466,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1467,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1468,                   /* -fvisibility= */
  OPT_fvpt = 1469,                           /* -fvpt */
  OPT_fvtable_gc = 1470,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1471,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1472,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1473,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1474,                     /* -fvtv-debug */
  OPT_fweak = 1475,                          /* -fweak */
  OPT_fweb = 1476,                           /* -fweb */
  /* OPT_fwhole_file = 1477, */              /* -fwhole-file */
  OPT_fwhole_program = 1478,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1479,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1480,             /* -fworking-directory */
  OPT_fwpa = 1481,                           /* -fwpa */
  OPT_fwpa_ = 1482,                          /* -fwpa= */
  OPT_fwrapv = 1483,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1484,                 /* -fwrapv-pointer */
  OPT_fxref = 1485,                          /* -fxref */
  /* OPT_fzee = 1486, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1487,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1488,                     /* -fzero-link */
  OPT_g = 1489,                              /* -g */
  OPT_gant = 1490,                           /* -gant */
  OPT_gas_loc_support = 1491,                /* -gas-loc-support */
  OPT_gas_locview_support = 1492,            /* -gas-locview-support */
  OPT_gcoff = 1493,                          /* -gcoff */
  OPT_gcoff1 = 1494,                         /* -gcoff1 */
  OPT_gcoff2 = 1495,                         /* -gcoff2 */
  OPT_gcoff3 = 1496,                         /* -gcoff3 */
  OPT_gcolumn_info = 1497,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1498,                 /* -gdescribe-dies */
  OPT_gdwarf = 1499,                         /* -gdwarf */
  OPT_gdwarf_ = 1500,                        /* -gdwarf- */
  OPT_gen_decls = 1501,                      /* -gen-decls */
  OPT_ggdb = 1502,                           /* -ggdb */
  OPT_ggnu_pubnames = 1503,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1504,                   /* -gimple-stats */
  OPT_ginline_points = 1505,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1506, /* -ginternal-reset-location-views */
  OPT_gnat = 1507,                           /* -gnat */
  OPT_gnatO = 1508,                          /* -gnatO */
  OPT_gno_ = 1509,                           /* -gno- */
  OPT_gno_pubnames = 1510,                   /* -gno-pubnames */
  OPT_gpubnames = 1511,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1512,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1513,                   /* -gsplit-dwarf */
  OPT_gstabs = 1514,                         /* -gstabs */
  OPT_gstabs_ = 1515,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1516,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1517,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1518,                        /* -gtoggle */
  OPT_gvariable_location_views = 1519,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1520,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1521,                           /* -gvms */
  OPT_gxcoff = 1522,                         /* -gxcoff */
  OPT_gxcoff_ = 1523,                        /* -gxcoff+ */
  OPT_gz = 1524,                             /* -gz */
  OPT_gz_ = 1525,                            /* -gz= */
  OPT_h = 1526,                              /* -h */
  OPT_help = 1527,                           /* -help */
  OPT_idirafter = 1528,                      /* -idirafter */
  OPT_imacros = 1529,                        /* -imacros */
  OPT_imultiarch = 1530,                     /* -imultiarch */
  OPT_imultilib = 1531,                      /* -imultilib */
  OPT_include = 1532,                        /* -include */
  OPT_iplugindir_ = 1533,                    /* -iplugindir= */
  OPT_iprefix = 1534,                        /* -iprefix */
  OPT_iquote = 1535,                         /* -iquote */
  OPT_isysroot = 1536,                       /* -isysroot */
  OPT_isystem = 1537,                        /* -isystem */
  OPT_iwithprefix = 1538,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1539,              /* -iwithprefixbefore */
  OPT_k8 = 1540,                             /* -k8 */
  OPT_l = 1541,                              /* -l */
  OPT_lang_asm = 1542,                       /* -lang-asm */
  OPT_list = 1543,                           /* -list */
  OPT_mabi_ = 1544,                          /* -mabi= */
  OPT_march_ = 1545,                         /* -march= */
  OPT_mbig_endian = 1546,                    /* -mbig-endian */
  OPT_mbionic = 1547,                        /* -mbionic */
  OPT_mbranch_protection_ = 1548,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1549,                       /* -mcmodel= */
  OPT_mcpu_ = 1550,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1551,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1552,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1553,             /* -mgeneral-regs-only */
  OPT_mglibc = 1554,                         /* -mglibc */
  OPT_mlittle_endian = 1555,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1556,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1557,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1558,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1559,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1560,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1561,               /* -moutline-atomics */
  OPT_moverride_ = 1562,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1563,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1564,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1565, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1566,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1567,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1568,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1569,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1570,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1571,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1572,             /* -mtrack-speculation */
  OPT_mtune_ = 1573,                         /* -mtune= */
  OPT_muclibc = 1574,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1575,             /* -mverbose-cost-dump */
  OPT_n = 1576,                              /* -n */
  OPT_name_sort = 1577,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1578,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1579,              /* -no-integrated-cpp */
  OPT_no_pie = 1580,                         /* -no-pie */
  OPT_nocpp = 1581,                          /* -nocpp */
  OPT_nodefaultlibs = 1582,                  /* -nodefaultlibs */
  OPT_nolibc = 1583,                         /* -nolibc */
  OPT_nophoboslib = 1584,                    /* -nophoboslib */
  OPT_nostartfiles = 1585,                   /* -nostartfiles */
  OPT_nostdinc = 1586,                       /* -nostdinc */
  OPT_nostdinc__ = 1587,                     /* -nostdinc++ */
  OPT_nostdlib = 1588,                       /* -nostdlib */
  OPT_o = 1589,                              /* -o */
  OPT_objects = 1590,                        /* -objects */
  OPT_p = 1591,                              /* -p */
  OPT_pass_exit_codes = 1592,                /* -pass-exit-codes */
  /* OPT_pedantic = 1593, */                 /* -pedantic */
  OPT_pedantic_errors = 1594,                /* -pedantic-errors */
  OPT_pg = 1595,                             /* -pg */
  OPT_pie = 1596,                            /* -pie */
  OPT_pipe = 1597,                           /* -pipe */
  OPT_posix = 1598,                          /* -posix */
  OPT_print_file_name_ = 1599,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1600,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1601,          /* -print-multi-directory */
  OPT_print_multi_lib = 1602,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1603,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1604,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1605,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1606,               /* -print-prog-name= */
  OPT_print_search_dirs = 1607,              /* -print-search-dirs */
  OPT_print_sysroot = 1608,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1609,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1610,                    /* -print-value */
  OPT_profile = 1611,                        /* -profile */
  OPT_pthread = 1612,                        /* -pthread */
  OPT_quiet = 1613,                          /* -quiet */
  OPT_r = 1614,                              /* -r */
  OPT_rdynamic = 1615,                       /* -rdynamic */
  OPT_remap = 1616,                          /* -remap */
  OPT_reverse_sort = 1617,                   /* -reverse-sort */
  OPT_s = 1618,                              /* -s */
  OPT_save_temps = 1619,                     /* -save-temps */
  OPT_save_temps_ = 1620,                    /* -save-temps= */
  OPT_shared = 1621,                         /* -shared */
  OPT_shared_libgcc = 1622,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1623,               /* -shared-libphobos */
  OPT_size_sort = 1624,                      /* -size-sort */
  /* OPT_specs = 1625, */                    /* -specs */
  OPT_specs_ = 1626,                         /* -specs= */
  OPT_static = 1627,                         /* -static */
  OPT_static_libasan = 1628,                 /* -static-libasan */
  OPT_static_libgcc = 1629,                  /* -static-libgcc */
  OPT_static_libgfortran = 1630,             /* -static-libgfortran */
  OPT_static_libgo = 1631,                   /* -static-libgo */
  OPT_static_liblsan = 1632,                 /* -static-liblsan */
  OPT_static_libmpx = 1633,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1634,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1635,               /* -static-libphobos */
  OPT_static_libstdc__ = 1636,               /* -static-libstdc++ */
  OPT_static_libtsan = 1637,                 /* -static-libtsan */
  OPT_static_libubsan = 1638,                /* -static-libubsan */
  OPT_static_pie = 1639,                     /* -static-pie */
  /* OPT_std_c__03 = 1640, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1641, */                /* -std=c++0x */
  OPT_std_c__11 = 1642,                      /* -std=c++11 */
  OPT_std_c__14 = 1643,                      /* -std=c++14 */
  OPT_std_c__17 = 1644,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1645, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1646, */                /* -std=c++1z */
  OPT_std_c__2a = 1647,                      /* -std=c++2a */
  OPT_std_c__98 = 1648,                      /* -std=c++98 */
  OPT_std_c11 = 1649,                        /* -std=c11 */
  OPT_std_c17 = 1650,                        /* -std=c17 */
  /* OPT_std_c18 = 1651, */                  /* -std=c18 */
  /* OPT_std_c1x = 1652, */                  /* -std=c1x */
  OPT_std_c2x = 1653,                        /* -std=c2x */
  /* OPT_std_c89 = 1654, */                  /* -std=c89 */
  OPT_std_c90 = 1655,                        /* -std=c90 */
  OPT_std_c99 = 1656,                        /* -std=c99 */
  /* OPT_std_c9x = 1657, */                  /* -std=c9x */
  OPT_std_f2003 = 1658,                      /* -std=f2003 */
  OPT_std_f2008 = 1659,                      /* -std=f2008 */
  OPT_std_f2008ts = 1660,                    /* -std=f2008ts */
  OPT_std_f2018 = 1661,                      /* -std=f2018 */
  OPT_std_f95 = 1662,                        /* -std=f95 */
  OPT_std_gnu = 1663,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1664, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1665, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1666,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1667,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1668,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1669, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1670, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1671,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1672,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1673,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1674,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1675, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1676, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1677,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1678, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1679,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1680,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1681, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1682, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1683,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1684, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1685, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1686, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1687, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1688, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1689,                     /* -std=legacy */
  OPT_symbol_ = 1690,                        /* -symbol= */
  OPT_symbolic = 1691,                       /* -symbolic */
  OPT_t = 1692,                              /* -t */
  OPT_time = 1693,                           /* -time */
  OPT_time_ = 1694,                          /* -time= */
  OPT_traditional = 1695,                    /* -traditional */
  OPT_traditional_cpp = 1696,                /* -traditional-cpp */
  OPT_tree_stats = 1697,                     /* -tree-stats */
  OPT_trigraphs = 1698,                      /* -trigraphs */
  OPT_type_stats = 1699,                     /* -type-stats */
  OPT_u = 1700,                              /* -u */
  OPT_undef = 1701,                          /* -undef */
  OPT_v = 1702,                              /* -v */
  OPT_version = 1703,                        /* -version */
  OPT_w = 1704,                              /* -w */
  OPT_wrapper = 1705,                        /* -wrapper */
  OPT_x = 1706,                              /* -x */
  OPT_z = 1707,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
