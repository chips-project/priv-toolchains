...
enum opt_code
{
  ...
  OPT_mbranch_protection_ = 1547,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1548,                       /* -mcmodel= */
  OPT_mcpu_ = 1549,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1550,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1551,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1552,             /* -mgeneral-regs-only */
  OPT_mlittle_endian = 1553,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1554,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1555,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1556,            /* -mlow-precision-sqrt */
  OPT_momit_leaf_frame_pointer = 1557,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1558,               /* -moutline-atomics */
  OPT_moverride_ = 1559,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1560,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1561,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1562, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1563,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1564,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1565,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1566,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1567,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1568,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1569,             /* -mtrack-speculation */
  OPT_mtune_ = 1570,                         /* -mtune= */
  OPT_mverbose_cost_dump = 1571,             /* -mverbose-cost-dump */
  OPT_n = 1572,                              /* -n */
  OPT_name_sort = 1573,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1574,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1575,              /* -no-integrated-cpp */
  OPT_no_pie = 1576,                         /* -no-pie */
  OPT_nocpp = 1577,                          /* -nocpp */
  OPT_nodefaultlibs = 1578,                  /* -nodefaultlibs */
  OPT_nolibc = 1579,                         /* -nolibc */
  OPT_nophoboslib = 1580,                    /* -nophoboslib */
  OPT_nostartfiles = 1581,                   /* -nostartfiles */
  OPT_nostdinc = 1582,                       /* -nostdinc */
  OPT_nostdinc__ = 1583,                     /* -nostdinc++ */
  OPT_nostdlib = 1584,                       /* -nostdlib */
  OPT_o = 1585,                              /* -o */
  OPT_objects = 1586,                        /* -objects */
  OPT_p = 1587,                              /* -p */
  OPT_pass_exit_codes = 1588,                /* -pass-exit-codes */
  /* OPT_pedantic = 1589, */                 /* -pedantic */
  OPT_pedantic_errors = 1590,                /* -pedantic-errors */
  OPT_pg = 1591,                             /* -pg */
  OPT_pie = 1592,                            /* -pie */
  OPT_pipe = 1593,                           /* -pipe */
  OPT_print_file_name_ = 1594,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1595,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1596,          /* -print-multi-directory */
  OPT_print_multi_lib = 1597,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1598,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1599,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1600,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1601,               /* -print-prog-name= */
  OPT_print_search_dirs = 1602,              /* -print-search-dirs */
  OPT_print_sysroot = 1603,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1604,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1605,                    /* -print-value */
  OPT_quiet = 1606,                          /* -quiet */
  OPT_r = 1607,                              /* -r */
  OPT_remap = 1608,                          /* -remap */
  OPT_reverse_sort = 1609,                   /* -reverse-sort */
  OPT_s = 1610,                              /* -s */
  OPT_save_temps = 1611,                     /* -save-temps */
  OPT_save_temps_ = 1612,                    /* -save-temps= */
  OPT_shared = 1613,                         /* -shared */
  OPT_shared_libgcc = 1614,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1615,               /* -shared-libphobos */
  OPT_size_sort = 1616,                      /* -size-sort */
  /* OPT_specs = 1617, */                    /* -specs */
  OPT_specs_ = 1618,                         /* -specs= */
  OPT_static = 1619,                         /* -static */
  OPT_static_libasan = 1620,                 /* -static-libasan */
  OPT_static_libgcc = 1621,                  /* -static-libgcc */
  OPT_static_libgfortran = 1622,             /* -static-libgfortran */
  OPT_static_libgo = 1623,                   /* -static-libgo */
  OPT_static_liblsan = 1624,                 /* -static-liblsan */
  OPT_static_libmpx = 1625,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1626,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1627,               /* -static-libphobos */
  OPT_static_libstdc__ = 1628,               /* -static-libstdc++ */
  OPT_static_libtsan = 1629,                 /* -static-libtsan */
  OPT_static_libubsan = 1630,                /* -static-libubsan */
  OPT_static_pie = 1631,                     /* -static-pie */
  /* OPT_std_c__03 = 1632, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1633, */                /* -std=c++0x */
  OPT_std_c__11 = 1634,                      /* -std=c++11 */
  OPT_std_c__14 = 1635,                      /* -std=c++14 */
  OPT_std_c__17 = 1636,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1637, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1638, */                /* -std=c++1z */
  OPT_std_c__2a = 1639,                      /* -std=c++2a */
  OPT_std_c__98 = 1640,                      /* -std=c++98 */
  OPT_std_c11 = 1641,                        /* -std=c11 */
  OPT_std_c17 = 1642,                        /* -std=c17 */
  /* OPT_std_c18 = 1643, */                  /* -std=c18 */
  /* OPT_std_c1x = 1644, */                  /* -std=c1x */
  OPT_std_c2x = 1645,                        /* -std=c2x */
  /* OPT_std_c89 = 1646, */                  /* -std=c89 */
  OPT_std_c90 = 1647,                        /* -std=c90 */
  OPT_std_c99 = 1648,                        /* -std=c99 */
  /* OPT_std_c9x = 1649, */                  /* -std=c9x */
  OPT_std_f2003 = 1650,                      /* -std=f2003 */
  OPT_std_f2008 = 1651,                      /* -std=f2008 */
  OPT_std_f2008ts = 1652,                    /* -std=f2008ts */
  OPT_std_f2018 = 1653,                      /* -std=f2018 */
  OPT_std_f95 = 1654,                        /* -std=f95 */
  OPT_std_gnu = 1655,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1656, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1657, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1658,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1659,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1660,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1661, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1662, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1663,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1664,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1665,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1666,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1667, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1668, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1669,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1670, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1671,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1672,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1673, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1674, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1675,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1676, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1677, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1678, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1679, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1680, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1681,                     /* -std=legacy */
  OPT_symbol_ = 1682,                        /* -symbol= */
  OPT_symbolic = 1683,                       /* -symbolic */
  OPT_t = 1684,                              /* -t */
  OPT_time = 1685,                           /* -time */
  OPT_time_ = 1686,                          /* -time= */
  OPT_traditional = 1687,                    /* -traditional */
  OPT_traditional_cpp = 1688,                /* -traditional-cpp */
  OPT_tree_stats = 1689,                     /* -tree-stats */
  OPT_trigraphs = 1690,                      /* -trigraphs */
  OPT_type_stats = 1691,                     /* -type-stats */
  OPT_u = 1692,                              /* -u */
  OPT_undef = 1693,                          /* -undef */
  OPT_v = 1694,                              /* -v */
  OPT_version = 1695,                        /* -version */
  OPT_w = 1696,                              /* -w */
  OPT_wrapper = 1697,                        /* -wrapper */
  OPT_x = 1698,                              /* -x */
  OPT_z = 1699,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
