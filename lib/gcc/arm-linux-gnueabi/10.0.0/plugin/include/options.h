...
#endif
#ifdef GENERATOR_FILE
extern int param_ipcp_unit_growth;
#else
  int x_param_ipcp_unit_growth;
#define param_ipcp_unit_growth global_options.x_param_ipcp_unit_growth
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT__param_asan_globals_ = 64,             /* --param=asan-globals= */
  OPT__param_asan_instrument_allocas_ = 65,  /* --param=asan-instrument-allocas= */
  OPT__param_asan_instrument_reads_ = 66,    /* --param=asan-instrument-reads= */
  OPT__param_asan_instrument_writes_ = 67,   /* --param=asan-instrument-writes= */
  OPT__param_asan_instrumentation_with_call_threshold_ = 68,/* --param=asan-instrumentation-with-call-threshold= */
  OPT__param_asan_memintrin_ = 69,           /* --param=asan-memintrin= */
  OPT__param_asan_stack_ = 70,               /* --param=asan-stack= */
  OPT__param_asan_use_after_return_ = 71,    /* --param=asan-use-after-return= */
  OPT__param_avg_loop_niter_ = 72,           /* --param=avg-loop-niter= */
  OPT__param_avoid_fma_max_bits_ = 73,       /* --param=avoid-fma-max-bits= */
  OPT__param_builtin_expect_probability_ = 74,/* --param=builtin-expect-probability= */
  OPT__param_builtin_string_cmp_inline_length_ = 75,/* --param=builtin-string-cmp-inline-length= */
  OPT__param_case_values_threshold_ = 76,    /* --param=case-values-threshold= */
  OPT__param_comdat_sharing_probability_ = 77,/* --param=comdat-sharing-probability= */
  OPT__param_cxx_max_namespaces_for_diagnostic_help_ = 78,/* --param=cxx-max-namespaces-for-diagnostic-help= */
  OPT__param_dse_max_alias_queries_per_store_ = 79,/* --param=dse-max-alias-queries-per-store= */
  OPT__param_dse_max_object_size_ = 80,      /* --param=dse-max-object-size= */
  OPT__param_early_inlining_insns_ = 81,     /* --param=early-inlining-insns= */
  OPT__param_fsm_maximum_phi_arguments_ = 82,/* --param=fsm-maximum-phi-arguments= */
  OPT__param_fsm_scale_path_blocks_ = 83,    /* --param=fsm-scale-path-blocks= */
  OPT__param_fsm_scale_path_stmts_ = 84,     /* --param=fsm-scale-path-stmts= */
  OPT__param_gcse_after_reload_critical_fraction_ = 85,/* --param=gcse-after-reload-critical-fraction= */
  OPT__param_gcse_after_reload_partial_fraction_ = 86,/* --param=gcse-after-reload-partial-fraction= */
  OPT__param_gcse_cost_distance_ratio_ = 87, /* --param=gcse-cost-distance-ratio= */
  OPT__param_gcse_unrestricted_cost_ = 88,   /* --param=gcse-unrestricted-cost= */
  OPT__param_ggc_min_expand_ = 89,           /* --param=ggc-min-expand= */
  OPT__param_ggc_min_heapsize_ = 90,         /* --param=ggc-min-heapsize= */
  OPT__param_gimple_fe_computed_hot_bb_threshold_ = 91,/* --param=gimple-fe-computed-hot-bb-threshold= */
  OPT__param_graphite_allow_codegen_errors_ = 92,/* --param=graphite-allow-codegen-errors= */
  OPT__param_graphite_max_arrays_per_scop_ = 93,/* --param=graphite-max-arrays-per-scop= */
  OPT__param_graphite_max_nb_scop_params_ = 94,/* --param=graphite-max-nb-scop-params= */
  OPT__param_hash_table_verification_limit_ = 95,/* --param=hash-table-verification-limit= */
  OPT__param_hot_bb_count_fraction_ = 96,    /* --param=hot-bb-count-fraction= */
  OPT__param_hot_bb_count_ws_permille_ = 97, /* --param=hot-bb-count-ws-permille= */
  OPT__param_hot_bb_frequency_fraction_ = 98,/* --param=hot-bb-frequency-fraction= */
  OPT__param_hsa_gen_debug_stores_ = 99,     /* --param=hsa-gen-debug-stores= */
  OPT__param_inline_heuristics_hint_percent_ = 100,/* --param=inline-heuristics-hint-percent= */
  OPT__param_inline_min_speedup_ = 101,      /* --param=inline-min-speedup= */
  OPT__param_inline_unit_growth_ = 102,      /* --param=inline-unit-growth= */
  OPT__param_integer_share_limit_ = 103,     /* --param=integer-share-limit= */
  OPT__param_ipa_cp_eval_threshold_ = 104,   /* --param=ipa-cp-eval-threshold= */
  OPT__param_ipa_cp_loop_hint_bonus_ = 105,  /* --param=ipa-cp-loop-hint-bonus= */
  OPT__param_ipa_cp_max_recursive_depth_ = 106,/* --param=ipa-cp-max-recursive-depth= */
  OPT__param_ipa_cp_min_recursive_probability_ = 107,/* --param=ipa-cp-min-recursive-probability= */
  OPT__param_ipa_cp_recursion_penalty_ = 108,/* --param=ipa-cp-recursion-penalty= */
  OPT__param_ipa_cp_single_call_penalty_ = 109,/* --param=ipa-cp-single-call-penalty= */
  OPT__param_ipa_cp_value_list_size_ = 110,  /* --param=ipa-cp-value-list-size= */
  OPT__param_ipa_max_aa_steps_ = 111,        /* --param=ipa-max-aa-steps= */
  OPT__param_ipa_max_agg_items_ = 112,       /* --param=ipa-max-agg-items= */
  OPT__param_ipa_max_param_expr_ops_ = 113,  /* --param=ipa-max-param-expr-ops= */
  OPT__param_ipa_max_switch_predicate_bounds_ = 114,/* --param=ipa-max-switch-predicate-bounds= */
  OPT__param_ipa_sra_max_replacements_ = 115,/* --param=ipa-sra-max-replacements= */
  OPT__param_ipa_sra_ptr_growth_factor_ = 116,/* --param=ipa-sra-ptr-growth-factor= */
  OPT__param_ipcp_unit_growth_ = 117,        /* --param=ipcp-unit-growth= */
  OPT__param_ira_loop_reserved_regs_ = 118,  /* --param=ira-loop-reserved-regs= */
  OPT__param_ira_max_conflict_table_size_ = 119,/* --param=ira-max-conflict-table-size= */
  OPT__param_ira_max_loops_num_ = 120,       /* --param=ira-max-loops-num= */
  OPT__param_iv_always_prune_cand_set_bound_ = 121,/* --param=iv-always-prune-cand-set-bound= */
  OPT__param_iv_consider_all_candidates_bound_ = 122,/* --param=iv-consider-all-candidates-bound= */
  OPT__param_iv_max_considered_uses_ = 123,  /* --param=iv-max-considered-uses= */
  OPT__param_jump_table_max_growth_ratio_for_size_ = 124,/* --param=jump-table-max-growth-ratio-for-size= */
  OPT__param_jump_table_max_growth_ratio_for_speed_ = 125,/* --param=jump-table-max-growth-ratio-for-speed= */
  OPT__param_l1_cache_line_size_ = 126,      /* --param=l1-cache-line-size= */
  OPT__param_l1_cache_size_ = 127,           /* --param=l1-cache-size= */
  OPT__param_l2_cache_size_ = 128,           /* --param=l2-cache-size= */
  OPT__param_large_function_growth_ = 129,   /* --param=large-function-growth= */
  OPT__param_large_function_insns_ = 130,    /* --param=large-function-insns= */
  OPT__param_large_stack_frame_growth_ = 131,/* --param=large-stack-frame-growth= */
  OPT__param_large_stack_frame_ = 132,       /* --param=large-stack-frame= */
  OPT__param_large_unit_insns_ = 133,        /* --param=large-unit-insns= */
  OPT__param_lim_expensive_ = 134,           /* --param=lim-expensive= */
  OPT__param_logical_op_non_short_circuit_ = 135,/* --param=logical-op-non-short-circuit= */
  OPT__param_loop_block_tile_size_ = 136,    /* --param=loop-block-tile-size= */
  OPT__param_loop_interchange_max_num_stmts_ = 137,/* --param=loop-interchange-max-num-stmts= */
  OPT__param_loop_interchange_stride_ratio_ = 138,/* --param=loop-interchange-stride-ratio= */
  OPT__param_loop_invariant_max_bbs_in_loop_ = 139,/* --param=loop-invariant-max-bbs-in-loop= */
  OPT__param_loop_max_datarefs_for_datadeps_ = 140,/* --param=loop-max-datarefs-for-datadeps= */
  OPT__param_loop_versioning_max_inner_insns_ = 141,/* --param=loop-versioning-max-inner-insns= */
  OPT__param_loop_versioning_max_outer_insns_ = 142,/* --param=loop-versioning-max-outer-insns= */
  OPT__param_lra_inheritance_ebb_probability_cutoff_ = 143,/* --param=lra-inheritance-ebb-probability-cutoff= */
  OPT__param_lra_max_considered_reload_pseudos_ = 144,/* --param=lra-max-considered-reload-pseudos= */
  OPT__param_lto_max_partition_ = 145,       /* --param=lto-max-partition= */
  OPT__param_lto_max_streaming_parallelism_ = 146,/* --param=lto-max-streaming-parallelism= */
  OPT__param_lto_min_partition_ = 147,       /* --param=lto-min-partition= */
  OPT__param_lto_partitions_ = 148,          /* --param=lto-partitions= */
  OPT__param_max_average_unrolled_insns_ = 149,/* --param=max-average-unrolled-insns= */
  OPT__param_max_combine_insns_ = 150,       /* --param=max-combine-insns= */
  OPT__param_max_completely_peel_loop_nest_depth_ = 151,/* --param=max-completely-peel-loop-nest-depth= */
  OPT__param_max_completely_peel_times_ = 152,/* --param=max-completely-peel-times= */
  OPT__param_max_completely_peeled_insns_ = 153,/* --param=max-completely-peeled-insns= */
  OPT__param_max_crossjump_edges_ = 154,     /* --param=max-crossjump-edges= */
  OPT__param_max_cse_insns_ = 155,           /* --param=max-cse-insns= */
  OPT__param_max_cse_path_length_ = 156,     /* --param=max-cse-path-length= */
  OPT__param_max_cselib_memory_locations_ = 157,/* --param=max-cselib-memory-locations= */
  OPT__param_max_debug_marker_count_ = 158,  /* --param=max-debug-marker-count= */
  OPT__param_max_delay_slot_insn_search_ = 159,/* --param=max-delay-slot-insn-search= */
  OPT__param_max_delay_slot_live_search_ = 160,/* --param=max-delay-slot-live-search= */
  OPT__param_max_dse_active_local_stores_ = 161,/* --param=max-dse-active-local-stores= */
  OPT__param_max_early_inliner_iterations_ = 162,/* --param=max-early-inliner-iterations= */
  OPT__param_max_fields_for_field_sensitive_ = 163,/* --param=max-fields-for-field-sensitive= */
  OPT__param_max_fsm_thread_length_ = 164,   /* --param=max-fsm-thread-length= */
  OPT__param_max_fsm_thread_path_insns_ = 165,/* --param=max-fsm-thread-path-insns= */
  OPT__param_max_fsm_thread_paths_ = 166,    /* --param=max-fsm-thread-paths= */
  OPT__param_max_gcse_insertion_ratio_ = 167,/* --param=max-gcse-insertion-ratio= */
  OPT__param_max_gcse_memory_ = 168,         /* --param=max-gcse-memory= */
  OPT__param_max_goto_duplication_insns_ = 169,/* --param=max-goto-duplication-insns= */
  OPT__param_max_grow_copy_bb_insns_ = 170,  /* --param=max-grow-copy-bb-insns= */
  OPT__param_max_hoist_depth_ = 171,         /* --param=max-hoist-depth= */
  OPT__param_max_inline_insns_auto_ = 172,   /* --param=max-inline-insns-auto= */
  OPT__param_max_inline_insns_recursive_auto_ = 173,/* --param=max-inline-insns-recursive-auto= */
  OPT__param_max_inline_insns_recursive_ = 174,/* --param=max-inline-insns-recursive= */
  OPT__param_max_inline_insns_single_ = 175, /* --param=max-inline-insns-single= */
  OPT__param_max_inline_insns_size_ = 176,   /* --param=max-inline-insns-size= */
  OPT__param_max_inline_insns_small_ = 177,  /* --param=max-inline-insns-small= */
  OPT__param_max_inline_recursive_depth_auto_ = 178,/* --param=max-inline-recursive-depth-auto= */
  OPT__param_max_inline_recursive_depth_ = 179,/* --param=max-inline-recursive-depth= */
  OPT__param_max_isl_operations_ = 180,      /* --param=max-isl-operations= */
  OPT__param_max_iterations_computation_cost_ = 181,/* --param=max-iterations-computation-cost= */
  OPT__param_max_iterations_to_track_ = 182, /* --param=max-iterations-to-track= */
  OPT__param_max_jump_thread_duplication_stmts_ = 183,/* --param=max-jump-thread-duplication-stmts= */
  OPT__param_max_last_value_rtl_ = 184,      /* --param=max-last-value-rtl= */
  OPT__param_max_loop_header_insns_ = 185,   /* --param=max-loop-header-insns= */
  OPT__param_max_modulo_backtrack_attempts_ = 186,/* --param=max-modulo-backtrack-attempts= */
  OPT__param_max_partial_antic_length_ = 187,/* --param=max-partial-antic-length= */
  OPT__param_max_peel_branches_ = 188,       /* --param=max-peel-branches= */
  OPT__param_max_peel_times_ = 189,          /* --param=max-peel-times= */
  OPT__param_max_peeled_insns_ = 190,        /* --param=max-peeled-insns= */
  OPT__param_max_pending_list_length_ = 191, /* --param=max-pending-list-length= */
  OPT__param_max_pipeline_region_blocks_ = 192,/* --param=max-pipeline-region-blocks= */
  OPT__param_max_pipeline_region_insns_ = 193,/* --param=max-pipeline-region-insns= */
  OPT__param_max_pow_sqrt_depth_ = 194,      /* --param=max-pow-sqrt-depth= */
  OPT__param_max_predicted_iterations_ = 195,/* --param=max-predicted-iterations= */
  OPT__param_max_reload_search_insns_ = 196, /* --param=max-reload-search-insns= */
  OPT__param_max_rtl_if_conversion_insns_ = 197,/* --param=max-rtl-if-conversion-insns= */
  OPT__param_max_rtl_if_conversion_predictable_cost_ = 198,/* --param=max-rtl-if-conversion-predictable-cost= */
  OPT__param_max_rtl_if_conversion_unpredictable_cost_ = 199,/* --param=max-rtl-if-conversion-unpredictable-cost= */
  OPT__param_max_sched_extend_regions_iters_ = 200,/* --param=max-sched-extend-regions-iters= */
  OPT__param_max_sched_insn_conflict_delay_ = 201,/* --param=max-sched-insn-conflict-delay= */
  OPT__param_max_sched_ready_insns_ = 202,   /* --param=max-sched-ready-insns= */
  OPT__param_max_sched_region_blocks_ = 203, /* --param=max-sched-region-blocks= */
  OPT__param_max_sched_region_insns_ = 204,  /* --param=max-sched-region-insns= */
  OPT__param_max_slsr_cand_scan_ = 205,      /* --param=max-slsr-cand-scan= */
  OPT__param_max_speculative_devirt_maydefs_ = 206,/* --param=max-speculative-devirt-maydefs= */
  OPT__param_max_ssa_name_query_depth_ = 207,/* --param=max-ssa-name-query-depth= */
  OPT__param_max_stores_to_merge_ = 208,     /* --param=max-stores-to-merge= */
  OPT__param_max_stores_to_sink_ = 209,      /* --param=max-stores-to-sink= */
  OPT__param_max_tail_merge_comparisons_ = 210,/* --param=max-tail-merge-comparisons= */
  OPT__param_max_tail_merge_iterations_ = 211,/* --param=max-tail-merge-iterations= */
  OPT__param_max_tracked_strlens_ = 212,     /* --param=max-tracked-strlens= */
  OPT__param_max_tree_if_conversion_phi_args_ = 213,/* --param=max-tree-if-conversion-phi-args= */
  OPT__param_max_unroll_times_ = 214,        /* --param=max-unroll-times= */
  OPT__param_max_unrolled_insns_ = 215,      /* --param=max-unrolled-insns= */
  OPT__param_max_unswitch_insns_ = 216,      /* --param=max-unswitch-insns= */
  OPT__param_max_unswitch_level_ = 217,      /* --param=max-unswitch-level= */
  OPT__param_max_variable_expansions_in_unroller_ = 218,/* --param=max-variable-expansions-in-unroller= */
  OPT__param_max_vartrack_expr_depth_ = 219, /* --param=max-vartrack-expr-depth= */
  OPT__param_max_vartrack_reverse_op_size_ = 220,/* --param=max-vartrack-reverse-op-size= */
  OPT__param_max_vartrack_size_ = 221,       /* --param=max-vartrack-size= */
  OPT__param_max_vrp_switch_assertions_ = 222,/* --param=max-vrp-switch-assertions= */
  OPT__param_min_crossjump_insns_ = 223,     /* --param=min-crossjump-insns= */
  OPT__param_min_inline_recursive_probability_ = 224,/* --param=min-inline-recursive-probability= */
  OPT__param_min_insn_to_prefetch_ratio_ = 225,/* --param=min-insn-to-prefetch-ratio= */
  OPT__param_min_loop_cond_split_prob_ = 226,/* --param=min-loop-cond-split-prob= */
  OPT__param_min_nondebug_insn_uid_ = 227,   /* --param=min-nondebug-insn-uid= */
  OPT__param_min_size_for_stack_sharing_ = 228,/* --param=min-size-for-stack-sharing= */
  OPT__param_min_spec_prob_ = 229,           /* --param=min-spec-prob= */
  OPT__param_min_vect_loop_bound_ = 230,     /* --param=min-vect-loop-bound= */
  OPT__param_parloops_chunk_size_ = 231,     /* --param=parloops-chunk-size= */
  OPT__param_parloops_min_per_thread_ = 232, /* --param=parloops-min-per-thread= */
  OPT__param_parloops_schedule_ = 233,       /* --param=parloops-schedule= */
  OPT__param_partial_inlining_entry_probability_ = 234,/* --param=partial-inlining-entry-probability= */
  OPT__param_predictable_branch_outcome_ = 235,/* --param=predictable-branch-outcome= */
  OPT__param_prefetch_dynamic_strides_ = 236,/* --param=prefetch-dynamic-strides= */
  OPT__param_prefetch_latency_ = 237,        /* --param=prefetch-latency= */
  OPT__param_prefetch_min_insn_to_mem_ratio_ = 238,/* --param=prefetch-min-insn-to-mem-ratio= */
  OPT__param_prefetch_minimum_stride_ = 239, /* --param=prefetch-minimum-stride= */
  OPT__param_profile_func_internal_id_ = 240,/* --param=profile-func-internal-id= */
  OPT__param_rpo_vn_max_loop_depth_ = 241,   /* --param=rpo-vn-max-loop-depth= */
  OPT__param_sccvn_max_alias_queries_per_access_ = 242,/* --param=sccvn-max-alias-queries-per-access= */
  OPT__param_scev_max_expr_complexity_ = 243,/* --param=scev-max-expr-complexity= */
  OPT__param_scev_max_expr_size_ = 244,      /* --param=scev-max-expr-size= */
  OPT__param_sched_autopref_queue_depth_ = 245,/* --param=sched-autopref-queue-depth= */
  OPT__param_sched_mem_true_dep_cost_ = 246, /* --param=sched-mem-true-dep-cost= */
  OPT__param_sched_pressure_algorithm_ = 247,/* --param=sched-pressure-algorithm= */
  OPT__param_sched_spec_prob_cutoff_ = 248,  /* --param=sched-spec-prob-cutoff= */
  OPT__param_sched_state_edge_prob_cutoff_ = 249,/* --param=sched-state-edge-prob-cutoff= */
  OPT__param_selsched_insns_to_rename_ = 250,/* --param=selsched-insns-to-rename= */
  OPT__param_selsched_max_lookahead_ = 251,  /* --param=selsched-max-lookahead= */
  OPT__param_selsched_max_sched_times_ = 252,/* --param=selsched-max-sched-times= */
  OPT__param_simultaneous_prefetches_ = 253, /* --param=simultaneous-prefetches= */
  OPT__param_sink_frequency_threshold_ = 254,/* --param=sink-frequency-threshold= */
  OPT__param_slp_max_insns_in_bb_ = 255,     /* --param=slp-max-insns-in-bb= */
  OPT__param_sms_dfa_history_ = 256,         /* --param=sms-dfa-history= */
  OPT__param_sms_loop_average_count_threshold_ = 257,/* --param=sms-loop-average-count-threshold= */
  OPT__param_sms_max_ii_factor_ = 258,       /* --param=sms-max-ii-factor= */
  OPT__param_sms_min_sc_ = 259,              /* --param=sms-min-sc= */
  OPT__param_sra_max_scalarization_size_Osize_ = 260,/* --param=sra-max-scalarization-size-Osize= */
  OPT__param_sra_max_scalarization_size_Ospeed_ = 261,/* --param=sra-max-scalarization-size-Ospeed= */
  OPT__param_ssa_name_def_chain_limit_ = 262,/* --param=ssa-name-def-chain-limit= */
  OPT__param_ssp_buffer_size_ = 263,         /* --param=ssp-buffer-size= */
  OPT__param_stack_clash_protection_guard_size_ = 264,/* --param=stack-clash-protection-guard-size= */
  OPT__param_stack_clash_protection_probe_interval_ = 265,/* --param=stack-clash-protection-probe-interval= */
  OPT__param_store_merging_allow_unaligned_ = 266,/* --param=store-merging-allow-unaligned= */
  OPT__param_store_merging_max_size_ = 267,  /* --param=store-merging-max-size= */
  OPT__param_switch_conversion_max_branch_ratio_ = 268,/* --param=switch-conversion-max-branch-ratio= */
  OPT__param_tm_max_aggregate_size_ = 269,   /* --param=tm-max-aggregate-size= */
  OPT__param_tracer_dynamic_coverage_feedback_ = 270,/* --param=tracer-dynamic-coverage-feedback= */
  OPT__param_tracer_dynamic_coverage_ = 271, /* --param=tracer-dynamic-coverage= */
  OPT__param_tracer_max_code_growth_ = 272,  /* --param=tracer-max-code-growth= */
  OPT__param_tracer_min_branch_probability_feedback_ = 273,/* --param=tracer-min-branch-probability-feedback= */
  OPT__param_tracer_min_branch_probability_ = 274,/* --param=tracer-min-branch-probability= */
  OPT__param_tracer_min_branch_ratio_ = 275, /* --param=tracer-min-branch-ratio= */
  OPT__param_tree_reassoc_width_ = 276,      /* --param=tree-reassoc-width= */
  OPT__param_uninit_control_dep_attempts_ = 277,/* --param=uninit-control-dep-attempts= */
  OPT__param_uninlined_function_insns_ = 278,/* --param=uninlined-function-insns= */
  OPT__param_uninlined_function_time_ = 279, /* --param=uninlined-function-time= */
  OPT__param_uninlined_thunk_insns_ = 280,   /* --param=uninlined-thunk-insns= */
  OPT__param_uninlined_thunk_time_ = 281,    /* --param=uninlined-thunk-time= */
  OPT__param_unlikely_bb_count_fraction_ = 282,/* --param=unlikely-bb-count-fraction= */
  OPT__param_unroll_jam_max_unroll_ = 283,   /* --param=unroll-jam-max-unroll= */
  OPT__param_unroll_jam_min_percent_ = 284,  /* --param=unroll-jam-min-percent= */
  OPT__param_use_after_scope_direct_emission_threshold_ = 285,/* --param=use-after-scope-direct-emission-threshold= */
  OPT__param_use_canonical_types_ = 286,     /* --param=use-canonical-types= */
  OPT__param_vect_epilogues_nomask_ = 287,   /* --param=vect-epilogues-nomask= */
  OPT__param_vect_max_peeling_for_alignment_ = 288,/* --param=vect-max-peeling-for-alignment= */
  OPT__param_vect_max_version_for_alias_checks_ = 289,/* --param=vect-max-version-for-alias-checks= */
  OPT__param_vect_max_version_for_alignment_checks_ = 290,/* --param=vect-max-version-for-alignment-checks= */
  /* OPT__pass_exit_codes = 291, */          /* --pass-exit-codes */
  /* OPT__pedantic = 292, */                 /* --pedantic */
  /* OPT__pedantic_errors = 293, */          /* --pedantic-errors */
  /* OPT__pie = 294, */                      /* --pie */
  /* OPT__pipe = 295, */                     /* --pipe */
  /* OPT__prefix = 296, */                   /* --prefix */
  /* OPT__prefix_ = 297, */                  /* --prefix= */
  /* OPT__preprocess = 298, */               /* --preprocess */
  /* OPT__print_file_name = 299, */          /* --print-file-name */
  /* OPT__print_file_name_ = 300, */         /* --print-file-name= */
  /* OPT__print_libgcc_file_name = 301, */   /* --print-libgcc-file-name */
  /* OPT__print_missing_file_dependencies = 302, *//* --print-missing-file-dependencies */
  /* OPT__print_multi_directory = 303, */    /* --print-multi-directory */
  /* OPT__print_multi_lib = 304, */          /* --print-multi-lib */
  /* OPT__print_multi_os_directory = 305, */ /* --print-multi-os-directory */
  /* OPT__print_multiarch = 306, */          /* --print-multiarch */
  /* OPT__print_prog_name = 307, */          /* --print-prog-name */
  /* OPT__print_prog_name_ = 308, */         /* --print-prog-name= */
  /* OPT__print_search_dirs = 309, */        /* --print-search-dirs */
  /* OPT__print_sysroot = 310, */            /* --print-sysroot */
  /* OPT__print_sysroot_headers_suffix = 311, *//* --print-sysroot-headers-suffix */
  /* OPT__profile = 312, */                  /* --profile */
  /* OPT__save_temps = 313, */               /* --save-temps */
  /* OPT__shared = 314, */                   /* --shared */
  /* OPT__specs = 315, */                    /* --specs */
  /* OPT__specs_ = 316, */                   /* --specs= */
  /* OPT__static = 317, */                   /* --static */
  /* OPT__static_pie = 318, */               /* --static-pie */
  /* OPT__symbolic = 319, */                 /* --symbolic */
  /* OPT__sysroot = 320, */                  /* --sysroot */
  OPT__sysroot_ = 321,                       /* --sysroot= */
  OPT__target_help = 322,                    /* --target-help */
  /* OPT__time = 323, */                     /* --time */
  /* OPT__trace_includes = 324, */           /* --trace-includes */
  /* OPT__traditional = 325, */              /* --traditional */
  /* OPT__traditional_cpp = 326, */          /* --traditional-cpp */
  /* OPT__trigraphs = 327, */                /* --trigraphs */
  /* OPT__undefine_macro = 328, */           /* --undefine-macro */
  /* OPT__undefine_macro_ = 329, */          /* --undefine-macro= */
  /* OPT__user_dependencies = 330, */        /* --user-dependencies */
  /* OPT__verbose = 331, */                  /* --verbose */
  OPT__version = 332,                        /* --version */
  /* OPT__write_dependencies = 333, */       /* --write-dependencies */
  /* OPT__write_user_dependencies = 334, */  /* --write-user-dependencies */
  OPT_A = 335,                               /* -A */
  OPT_B = 336,                               /* -B */
  OPT_C = 337,                               /* -C */
  OPT_CC = 338,                              /* -CC */
  ...
  OPT_Tbss_ = 370,                           /* -Tbss= */
  OPT_Tdata = 371,                           /* -Tdata */
  OPT_Tdata_ = 372,                          /* -Tdata= */
  OPT_Ttext = 373,                           /* -Ttext */
  OPT_Ttext_ = 374,                          /* -Ttext= */
  OPT_U = 375,                               /* -U */
  /* OPT_W = 376, */                         /* -W */
  OPT_Wa_ = 377,                             /* -Wa, */
  OPT_Wabi = 378,                            /* -Wabi */
  OPT_Wabi_tag = 379,                        /* -Wabi-tag */
  OPT_Wabi_ = 380,                           /* -Wabi= */
  OPT_Wabsolute_value = 381,                 /* -Wabsolute-value */
  OPT_Waddress = 382,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 383,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 384,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 385,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 386,                       /* -Waliasing */
  OPT_Walign_commons = 387,                  /* -Walign-commons */
  /* OPT_Waligned_new = 388, */              /* -Waligned-new */
  OPT_Waligned_new_ = 389,                   /* -Waligned-new= */
  OPT_Wall = 390,                            /* -Wall */
  OPT_Walloc_size_larger_than_ = 391,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 392,                     /* -Walloc-zero */
  OPT_Walloca = 393,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 394,            /* -Walloca-larger-than= */
  OPT_Wampersand = 395,                      /* -Wampersand */
  OPT_Wargument_mismatch = 396,              /* -Wargument-mismatch */
  OPT_Warray_bounds = 397,                   /* -Warray-bounds */
  OPT_Warray_bounds_ = 398,                  /* -Warray-bounds= */
  OPT_Warray_temporaries = 399,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 400,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 401, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 402,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 403,              /* -Wattribute-warning */
  OPT_Wattributes = 404,                     /* -Wattributes */
  OPT_Wbad_function_cast = 405,              /* -Wbad-function-cast */
  OPT_Wbool_compare = 406,                   /* -Wbool-compare */
  OPT_Wbool_operation = 407,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 408,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 409,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 410,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 411, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 412,                   /* -Wc++11-compat */
  OPT_Wc__14_compat = 413,                   /* -Wc++14-compat */
  OPT_Wc__17_compat = 414,                   /* -Wc++17-compat */
  /* OPT_Wc__1z_compat = 415, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 416,                   /* -Wc++20-compat */
  /* OPT_Wc__2a_compat = 417, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 418,                 /* -Wc-binding-type */
  OPT_Wc11_c2x_compat = 419,                 /* -Wc11-c2x-compat */
  OPT_Wc90_c99_compat = 420,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 421,                 /* -Wc99-c11-compat */
  OPT_Wcannot_profile = 422,                 /* -Wcannot-profile */
  OPT_Wcast_align = 423,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 424,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 425,             /* -Wcast-function-type */
  OPT_Wcast_qual = 426,                      /* -Wcast-qual */
  OPT_Wcast_result = 427,                    /* -Wcast-result */
  /* OPT_Wcatch_value = 428, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 429,                   /* -Wcatch-value= */
  OPT_Wchar_subscripts = 430,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 431,           /* -Wcharacter-truncation */
  OPT_Wchkp = 432,                           /* -Wchkp */
  OPT_Wclass_conversion = 433,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 434,                /* -Wclass-memaccess */
  OPT_Wclobbered = 435,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 436,                /* -Wcomma-subscript */
  OPT_Wcomment = 437,                        /* -Wcomment */
  /* OPT_Wcomments = 438, */                 /* -Wcomments */
  OPT_Wcompare_reals = 439,                  /* -Wcompare-reals */
  OPT_Wconditionally_supported = 440,        /* -Wconditionally-supported */
  OPT_Wconversion = 441,                     /* -Wconversion */
  OPT_Wconversion_extra = 442,               /* -Wconversion-extra */
  OPT_Wconversion_null = 443,                /* -Wconversion-null */
  OPT_Wcoverage_mismatch = 444,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 445,                            /* -Wcpp */
  OPT_Wctor_dtor_privacy = 446,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 447,                  /* -Wdangling-else */
  OPT_Wdate_time = 448,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 449,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 450,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 451,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 452,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 453,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 454,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 455,        /* -Wdeprecated-declarations */
  OPT_Wdesignated_init = 456,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 457,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 458,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 459,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 460,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 461,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 462,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 463,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 464,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 465,                /* -Wduplicated-cond */
  OPT_Weffc__ = 466,                         /* -Weffc++ */
  OPT_Wempty_body = 467,                     /* -Wempty-body */
  OPT_Wendif_labels = 468,                   /* -Wendif-labels */
  OPT_Wenum_compare = 469,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 470,                /* -Wenum-conversion */
  OPT_Werror = 471,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 472, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 473,                         /* -Werror= */
  OPT_Wexpansion_to_defined = 474,           /* -Wexpansion-to-defined */
  OPT_Wextra = 475,                          /* -Wextra */
  OPT_Wextra_semi = 476,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 477,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 478,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 479,                    /* -Wfloat-equal */
  /* OPT_Wformat = 480, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 481,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 482,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 483,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 484,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 485, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 486,               /* -Wformat-overflow= */
  OPT_Wformat_security = 487,                /* -Wformat-security */
  OPT_Wformat_signedness = 488,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 489, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 490,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 491,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 492,             /* -Wformat-zero-length */
  OPT_Wformat_ = 493,                        /* -Wformat= */
  OPT_Wframe_address = 494,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 495,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 496,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 497,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 498,           /* -Wfunction-elimination */
  OPT_Whsa = 499,                            /* -Whsa */
  OPT_Wif_not_aligned = 500,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 501,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 502,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 503,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 504, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 505,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 506,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 507,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 508,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 509,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 510, */                   /* -Wimport */
  OPT_Winaccessible_base = 511,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 512,     /* -Wincompatible-pointer-types */
  OPT_Winherited_variadic_ctor = 513,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 514,             /* -Winit-list-lifetime */
  OPT_Winit_self = 515,                      /* -Winit-self */
  OPT_Winline = 516,                         /* -Winline */
  OPT_Wint_conversion = 517,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 518,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 519,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 520,               /* -Winteger-division */
  OPT_Wintrinsic_shadow = 521,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 522,                 /* -Wintrinsics-std */
  OPT_Winvalid_memory_model = 523,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 524,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 525,                    /* -Winvalid-pch */
  OPT_Wjump_misses_init = 526,               /* -Wjump-misses-init */
  OPT_Wl_ = 527,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 528, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 529,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 530,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 531,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 532,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 533,                     /* -Wlogical-op */
  OPT_Wlong_long = 534,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 535,              /* -Wlto-type-mismatch */
  OPT_Wmain = 536,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 537,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 538,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 539,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 540,         /* -Wmisleading-indentation */
  OPT_Wmismatched_tags = 541,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 542,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 543,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 544,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 545,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 546, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 547,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 548, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 549,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 550,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 551,             /* -Wmissing-prototypes */
  OPT_Wmudflap = 552,                        /* -Wmudflap */
  OPT_Wmultichar = 553,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 554,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 555,          /* -Wmultistatement-macros */
  OPT_Wnamespaces = 556,                     /* -Wnamespaces */
  OPT_Wnarrowing = 557,                      /* -Wnarrowing */
  OPT_Wnested_externs = 558,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 559, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 560, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_vla_larger_than = 561, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 562,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 563,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 564,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 565,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 566,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 567,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 568, */               /* -Wnormalized */
  OPT_Wnormalized_ = 569,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 570,               /* -Wnull-dereference */
  OPT_Wodr = 571,                            /* -Wodr */
  OPT_Wold_style_cast = 572,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 573,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 574,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 575,                    /* -Wopenmp-simd */
  OPT_Woverflow = 576,                       /* -Woverflow */
  OPT_Woverlength_strings = 577,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 578,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 579,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 580,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 581,            /* -Woverwrite-recursive */
  OPT_Wp_ = 582,                             /* -Wp, */
  OPT_Wpacked = 583,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 584,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 585,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 586,                         /* -Wpadded */
  OPT_Wparentheses = 587,                    /* -Wparentheses */
  OPT_Wpedantic = 588,                       /* -Wpedantic */
  OPT_Wpessimizing_move = 589,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 590, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 591,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 592,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 593,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 594,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 595,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 596,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 597,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 598,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 599,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 600,                       /* -Wprotocol */
  OPT_Wpsabi = 601,                          /* -Wpsabi */
  OPT_Wreal_q_constant = 602,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 603,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 604,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 605,                /* -Wredundant-decls */
  OPT_Wredundant_move = 606,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 607,                 /* -Wredundant-tags */
  OPT_Wregister = 608,                       /* -Wregister */
  OPT_Wreorder = 609,                        /* -Wreorder */
  OPT_Wrestrict = 610,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 611,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 612,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 613,           /* -Wscalar-storage-order */
  OPT_Wselector = 614,                       /* -Wselector */
  OPT_Wsequence_point = 615,                 /* -Wsequence-point */
  OPT_Wshadow = 616,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 617, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 618,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 619, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 620,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 621, */            /* -Wshadow=global */
  OPT_Wshadow_local = 622,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 623,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 624,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 625,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 626, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 627,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 628,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 629,                /* -Wsign-conversion */
  OPT_Wsign_promo = 630,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 631,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 632,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_div = 633,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 634,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 635,                    /* -Wspeculative */
  OPT_Wstack_protector = 636,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 637,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 638,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 639,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 640,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 641,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 642,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 643,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 644,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 645,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 646, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 647,             /* -Wstringop-overflow= */
  OPT_Wstringop_truncation = 648,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 649,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 650,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 651,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 652,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 653,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 654,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 655,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 656,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 657,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 658,               /* -Wsuggest-override */
  OPT_Wsurprising = 659,                     /* -Wsurprising */
  OPT_Wswitch = 660,                         /* -Wswitch */
  OPT_Wswitch_bool = 661,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 662,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 663,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 664,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 665,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 666,                      /* -Wsync-nand */
  OPT_Wsynth = 667,                          /* -Wsynth */
  OPT_Wsystem_headers = 668,                 /* -Wsystem-headers */
  OPT_Wtabs = 669,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 670,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 671,           /* -Wtautological-compare */
  OPT_Wtemplates = 672,                      /* -Wtemplates */
  OPT_Wterminate = 673,                      /* -Wterminate */
  OPT_Wtraditional = 674,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 675,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 676,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 677,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 678,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 679,            /* -Wundeclared-selector */
  OPT_Wundef = 680,                          /* -Wundef */
  OPT_Wundefined_do_loop = 681,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 682,                      /* -Wunderflow */
  OPT_Wuninitialized = 683,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 684,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 685, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 686, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 687,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 688,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 689,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 690,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 691, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 692,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 693,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 694,                /* -Wunused-function */
  OPT_Wunused_label = 695,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 696,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 697,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 698,               /* -Wunused-parameter */
  OPT_Wunused_result = 699,                  /* -Wunused-result */
  OPT_Wunused_value = 700,                   /* -Wunused-value */
  OPT_Wunused_variable = 701,                /* -Wunused-variable */
  OPT_Wuse_without_only = 702,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 703,                   /* -Wuseless-cast */
  OPT_Wvarargs = 704,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 705,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 706,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 707,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 708,            /* -Wvirtual-move-assign */
  OPT_Wvla = 709,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 710,               /* -Wvla-larger-than= */
  OPT_Wvolatile = 711,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 712,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 713,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 714,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 715,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 716,                       /* -Wzerotrip */
  OPT_X = 717,                               /* -X */
  OPT_Xassembler = 718,                      /* -Xassembler */
  OPT_Xf = 719,                              /* -Xf */
  OPT_Xlinker = 720,                         /* -Xlinker */
  OPT_Xpreprocessor = 721,                   /* -Xpreprocessor */
  OPT_Z = 722,                               /* -Z */
  OPT_ansi = 723,                            /* -ansi */
  OPT_aux_info = 724,                        /* -aux-info */
  /* OPT_aux_info_ = 725, */                 /* -aux-info= */
  OPT_auxbase = 726,                         /* -auxbase */
  OPT_auxbase_strip = 727,                   /* -auxbase-strip */
  OPT_c = 728,                               /* -c */
  OPT_callgraph = 729,                       /* -callgraph */
  OPT_coverage = 730,                        /* -coverage */
  OPT_cpp = 731,                             /* -cpp */
  OPT_cpp_ = 732,                            /* -cpp= */
  OPT_d = 733,                               /* -d */
  OPT_debuglib_ = 734,                       /* -debuglib= */
  OPT_defaultlib_ = 735,                     /* -defaultlib= */
  OPT_defined_only = 736,                    /* -defined-only */
  OPT_demangle = 737,                        /* -demangle */
  OPT_dstartfiles = 738,                     /* -dstartfiles */
  OPT_dump_body_ = 739,                      /* -dump-body= */
  OPT_dump_level_ = 740,                     /* -dump-level= */
  OPT_dumpbase = 741,                        /* -dumpbase */
  OPT_dumpdir = 742,                         /* -dumpdir */
  OPT_dumpfullversion = 743,                 /* -dumpfullversion */
  OPT_dumpmachine = 744,                     /* -dumpmachine */
  OPT_dumpspecs = 745,                       /* -dumpspecs */
  OPT_dumpversion = 746,                     /* -dumpversion */
  OPT_e = 747,                               /* -e */
  OPT_export_dynamic = 748,                  /* -export-dynamic */
  OPT_fPIC = 749,                            /* -fPIC */
  OPT_fPIE = 750,                            /* -fPIE */
  OPT_fRTS_ = 751,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 752,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 753,                   /* -fabi-version= */
  OPT_faccess_control = 754,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 755,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 756,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 757,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 758,                  /* -falign-commons */
  OPT_falign_functions = 759,                /* -falign-functions */
  OPT_falign_functions_ = 760,               /* -falign-functions= */
  OPT_falign_jumps = 761,                    /* -falign-jumps */
  OPT_falign_jumps_ = 762,                   /* -falign-jumps= */
  OPT_falign_labels = 763,                   /* -falign-labels */
  OPT_falign_labels_ = 764,                  /* -falign-labels= */
  OPT_falign_loops = 765,                    /* -falign-loops */
  OPT_falign_loops_ = 766,                   /* -falign-loops= */
  /* OPT_faligned_new = 767, */              /* -faligned-new */
  OPT_faligned_new_ = 768,                   /* -faligned-new= */
  OPT_fall_instantiations = 769,             /* -fall-instantiations */
  OPT_fall_intrinsics = 770,                 /* -fall-intrinsics */
  OPT_fall_virtual = 771,                    /* -fall-virtual */
  OPT_fallocation_dce = 772,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 773,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 774,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 775,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 776,/* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 777,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 778,         /* -falt-external-templates */
  /* OPT_fargument_alias = 779, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 780, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 781, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 782, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 783,            /* -fasan-shadow-offset= */
  OPT_fasm = 784,                            /* -fasm */
  OPT_fassert = 785,                         /* -fassert */
  OPT_fassociative_math = 786,               /* -fassociative-math */
  OPT_fassume_phsa = 787,                    /* -fassume-phsa */
  OPT_fasynchronous_unwind_tables = 788,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 789,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 790,                   /* -fauto-profile */
  OPT_fauto_profile_ = 791,                  /* -fauto-profile= */
  OPT_fautomatic = 792,                      /* -fautomatic */
  OPT_fbackslash = 793,                      /* -fbackslash */
  OPT_fbacktrace = 794,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 795,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 796,                   /* -fbounds-check */
  OPT_fbounds_check_ = 797,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 798,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 799,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 800, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 801, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 802, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 803,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 804,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 805,                        /* -fbuiltin */
  OPT_fbuiltin_ = 806,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 807,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 808,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 809,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 810,                    /* -fcall-saved- */
  OPT_fcall_used_ = 811,                     /* -fcall-used- */
  OPT_fcaller_saves = 812,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 813,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 814,                /* -fcallgraph-info= */
  OPT_fcanonical_system_headers = 815,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 816, */            /* -fcf-protection */
  OPT_fcf_protection_ = 817,                 /* -fcf-protection= */
  OPT_fchar8_t = 818,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 819,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 820, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 821,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 822,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 823,                         /* -fcheck= */
  OPT_fchecking = 824,                       /* -fchecking */
  OPT_fchecking_ = 825,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 826,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 827,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 828,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 829,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 830,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 831,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 832,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 833,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 834, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 835,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 836,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 837,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 838, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 839,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 840,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 841,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 842,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 843,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 844, */                 /* -fcilkplus */
  OPT_fcoarray_ = 845,                       /* -fcoarray= */
  OPT_fcode_hoisting = 846,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 847,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 848,                         /* -fcommon */
  OPT_fcompare_debug = 849,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 850,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 851,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 852,                   /* -fcompare-elim */
  OPT_fconcepts = 853,                       /* -fconcepts */
  OPT_fconcepts_ts = 854,                    /* -fconcepts-ts */
  OPT_fcond_mismatch = 855,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 856, */           /* -fconserve-space */
  OPT_fconserve_stack = 857,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 858,         /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 859,         /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 860,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 861,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 862,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 863,                       /* -fconvert= */
  OPT_fcprop_registers = 864,                /* -fcprop-registers */
  OPT_fcray_pointer = 865,                   /* -fcray-pointer */
  OPT_fcrossjumping = 866,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 867,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 868, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 869,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 870,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 871,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 872,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 873,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 874,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 875,                       /* -fdbg-cnt= */
  OPT_fdce = 876,                            /* -fdce */
  OPT_fdebug = 877,                          /* -fdebug */
  OPT_fdebug_cpp = 878,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 879,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 880,            /* -fdebug-types-section */
  OPT_fdebug_ = 881,                         /* -fdebug= */
  OPT_fdec = 882,                            /* -fdec */
  OPT_fdec_blank_format_item = 883,          /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 884,           /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 885,            /* -fdec-format-defaults */
  OPT_fdec_include = 886,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 887,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 888,                       /* -fdec-math */
  OPT_fdec_static = 889,                     /* -fdec-static */
  OPT_fdec_structure = 890,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 891,              /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 892, */         /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 893,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 894, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 895,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 896,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 897,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 898,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 899,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 900,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 901,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 902,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 903,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 904,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 905,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 906, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 907,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_format_ = 908,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 909,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 910,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 911,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 912,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 913,           /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 914,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 915,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 916,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 917,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 918, /* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 919,              /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 920,                /* -fdirectives-only */
  OPT_fdisable_ = 921,                       /* -fdisable- */
  OPT_fdoc = 922,                            /* -fdoc */
  OPT_fdoc_dir_ = 923,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 924,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 925,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 926,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 927,         /* -fdollars-in-identifiers */
  OPT_fdruntime = 928,                       /* -fdruntime */
  OPT_fdse = 929,                            /* -fdse */
  OPT_fdump_ = 930,                          /* -fdump- */
  OPT_fdump_ada_spec = 931,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 932,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 933, */                /* -fdump-core */
  OPT_fdump_d_original = 934,                /* -fdump-d-original */
  OPT_fdump_final_insns = 935,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 936,              /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 937,            /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 938,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 939,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 940,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 941,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 942,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 943, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 944,                    /* -fdump-passes */
  OPT_fdump_scos = 945,                      /* -fdump-scos */
  OPT_fdump_unnumbered = 946,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 947,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 948,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 949,                 /* -fearly-inlining */
  OPT_felide_constructors = 950,             /* -felide-constructors */
  OPT_felide_type = 951,                     /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 952, */    /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 953, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 954,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 955,        /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 956,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 957,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 958,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 959,                        /* -fenable- */
  OPT_fenforce_eh_specs = 960,               /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 961,                 /* -fenum-int-equiv */
  OPT_fexceptions = 962,                     /* -fexceptions */
  OPT_fexcess_precision_ = 963,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 964,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 965,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 966,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 967,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 968,                /* -fextern-tls-init */
  OPT_fexternal_blas = 969,                  /* -fexternal-blas */
  OPT_fexternal_templates = 970,             /* -fexternal-templates */
  OPT_ff2c = 971,                            /* -ff2c */
  OPT_ffast_math = 972,                      /* -ffast-math */
  OPT_ffat_lto_objects = 973,                /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 974,               /* -ffile-prefix-map= */
  OPT_ffinite_loops = 975,                   /* -ffinite-loops */
  OPT_ffinite_math_only = 976,               /* -ffinite-math-only */
  OPT_ffixed_ = 977,                         /* -ffixed- */
  OPT_ffixed_form = 978,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 979,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 980,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 981,                    /* -ffloat-store */
  OPT_ffor_scope = 982,                      /* -ffor-scope */
  /* OPT_fforce_addr = 983, */               /* -fforce-addr */
  OPT_fforward_propagate = 984,              /* -fforward-propagate */
  OPT_ffp_contract_ = 985,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 986,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 987,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 988,                      /* -ffpe-trap= */
  OPT_ffree_form = 989,                      /* -ffree-form */
  OPT_ffree_line_length_ = 990,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 991,          /* -ffree-line-length-none */
  OPT_ffreestanding = 992,                   /* -ffreestanding */
  OPT_ffriend_injection = 993,               /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 994,      /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 995,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 996,                   /* -ffunction-cse */
  OPT_ffunction_sections = 997,              /* -ffunction-sections */
  OPT_fgcse = 998,                           /* -fgcse */
  OPT_fgcse_after_reload = 999,              /* -fgcse-after-reload */
  OPT_fgcse_las = 1000,                      /* -fgcse-las */
  OPT_fgcse_lm = 1001,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1002,                       /* -fgcse-sm */
  OPT_fgimple = 1003,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1004,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1005,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1006,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1007,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1008,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1009,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1010,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1011,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1012,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1013,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1014,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1015,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1016,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1017,                      /* -fgo-dump- */
  OPT_fgo_optimize_ = 1018,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1019,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1020,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1021,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1022,                      /* -fgraphite */
  OPT_fgraphite_identity = 1023,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1024,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1025,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1026, */       /* -fhandle-exceptions */
  /* OPT_fhelp = 1027, */                    /* -fhelp */
  /* OPT_fhelp_ = 1028, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1029,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1030,                     /* -fhonor-std */
  OPT_fhosted = 1031,                        /* -fhosted */
  OPT_fhuge_objects = 1032,                  /* -fhuge-objects */
  OPT_fident = 1033,                         /* -fident */
  OPT_fif_conversion = 1034,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1035,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1036,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1037,             /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 1038,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1039,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1040,            /* -fimplicit-templates */
  OPT_findirect_inlining = 1041,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1042,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1043,               /* -finit-character= */
  OPT_finit_derived = 1044,                  /* -finit-derived */
  OPT_finit_integer_ = 1045,                 /* -finit-integer= */
  OPT_finit_local_zero = 1046,               /* -finit-local-zero */
  OPT_finit_logical_ = 1047,                 /* -finit-logical= */
  OPT_finit_real_ = 1048,                    /* -finit-real= */
  OPT_finline = 1049,                        /* -finline */
  OPT_finline_arg_packing = 1050,            /* -finline-arg-packing */
  OPT_finline_atomics = 1051,                /* -finline-atomics */
  OPT_finline_functions = 1052,              /* -finline-functions */
  OPT_finline_functions_called_once = 1053,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1054, */           /* -finline-limit- */
  OPT_finline_limit_ = 1055,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1056,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1057,        /* -finline-small-functions */
  OPT_finput_charset_ = 1058,                /* -finput-charset= */
  OPT_finstrument_functions = 1059,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1060,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1061,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 1062,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1063,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1064,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1065,                    /* -finvariants */
  OPT_fipa_bit_cp = 1066,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1067,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1068, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1069,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1070,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1071,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1072,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1073, */        /* -fipa-matrix-reorg */
  OPT_fipa_profile = 1074,                   /* -fipa-profile */
  OPT_fipa_pta = 1075,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1076,                /* -fipa-pure-const */
  OPT_fipa_ra = 1077,                        /* -fipa-ra */
  OPT_fipa_reference = 1078,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1079,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1080,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1081,           /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 1082, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1083,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1084,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1085,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1086,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1087,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1088,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1089,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1090,                  /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 1091,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1092,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1093,              /* -fivar-visibility= */
  OPT_fivopts = 1094,                        /* -fivopts */
  OPT_fjump_tables = 1095,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1096,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1097,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1098,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1099,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1100,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1101,                     /* -flabels-ok */
  OPT_flax_vector_conversions = 1102,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1103,            /* -fleading-underscore */
  OPT_flifetime_dse = 1104,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1105,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1106,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1107,                /* -flinker-output= */
  /* OPT_flive_patching = 1108, */           /* -flive-patching */
  OPT_flive_patching_ = 1109,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1110,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1111,                   /* -flocal-ivars */
  /* OPT_floop_block = 1112, */              /* -floop-block */
  /* OPT_floop_flatten = 1113, */            /* -floop-flatten */
  OPT_floop_interchange = 1114,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1115,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1116, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1117,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1118, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1119,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1120,                     /* -flra-remat */
  OPT_flto = 1121,                           /* -flto */
  OPT_flto_compression_level_ = 1122,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1123, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1124,                /* -flto-partition= */
  OPT_flto_report = 1125,                    /* -flto-report */
  OPT_flto_report_wpa = 1126,                /* -flto-report-wpa */
  OPT_flto_ = 1127,                          /* -flto= */
  OPT_fltrans = 1128,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1129,           /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 1130,             /* -fmacro-prefix-map= */
  OPT_fmain = 1131,                          /* -fmain */
  OPT_fmath_errno = 1132,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1133,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1134,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1135,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1136,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1137,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1138,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1139,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1140,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1141,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1142,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1143,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1144,               /* -fmessage-length= */
  OPT_fmodule_file_ = 1145,                  /* -fmodule-file= */
  OPT_fmodule_private = 1146,                /* -fmodule-private */
  OPT_fmoduleinfo = 1147,                    /* -fmoduleinfo */
  OPT_fmodulo_sched = 1148,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1149,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1150,          /* -fmove-loop-invariants */
  OPT_fms_extensions = 1151,                 /* -fms-extensions */
  OPT_fmudflap = 1152,                       /* -fmudflap */
  OPT_fmudflapir = 1153,                     /* -fmudflapir */
  OPT_fmudflapth = 1154,                     /* -fmudflapth */
  OPT_fname_mangling_version_ = 1155,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1156,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1157,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1158,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1159,                  /* -fnext-runtime */
  OPT_fnil_receivers = 1160,                 /* -fnil-receivers */
  OPT_fnon_call_exceptions = 1161,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1162,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1163,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1164,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1165,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1166,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1167,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1168,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1169,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1170,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1171,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1172,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1173,                  /* -foffload-abi= */
  OPT_foffload_ = 1174,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1175,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1176,                         /* -fonly= */
  OPT_fopenacc = 1177,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1178,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1179,                        /* -fopenmp */
  OPT_fopenmp_simd = 1180,                   /* -fopenmp-simd */
  OPT_foperator_names = 1181,                /* -foperator-names */
  OPT_fopt_info = 1182,                      /* -fopt-info */
  OPT_fopt_info_ = 1183,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1184, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1185,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1186,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1187, */          /* -foptional-diags */
  OPT_fpack_derived = 1188,                  /* -fpack-derived */
  OPT_fpack_struct = 1189,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1190,                  /* -fpack-struct= */
  OPT_fpad_source = 1191,                    /* -fpad-source */
  OPT_fpartial_inlining = 1192,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1193,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1194,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1195,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1196,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1197,                    /* -fpeel-loops */
  OPT_fpeephole = 1198,                      /* -fpeephole */
  OPT_fpeephole2 = 1199,                     /* -fpeephole2 */
  OPT_fpermissive = 1200,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1201,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1202,                           /* -fpic */
  OPT_fpie = 1203,                           /* -fpie */
  OPT_fplan9_extensions = 1204,              /* -fplan9-extensions */
  OPT_fplt = 1205,                           /* -fplt */
  OPT_fplugin_arg_ = 1206,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1207,                       /* -fplugin= */
  OPT_fpost_ipa_mem_report = 1208,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1209,                /* -fpostconditions */
  OPT_fpre_include_ = 1210,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1211,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1212,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1213,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1214,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1215,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1216,              /* -fpretty-templates */
  OPT_fprintf_return_value = 1217,           /* -fprintf-return-value */
  OPT_fprofile = 1218,                       /* -fprofile */
  OPT_fprofile_abs_path = 1219,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1220,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1221,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1222,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1223,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1224,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1225,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1226,             /* -fprofile-generate= */
  OPT_fprofile_note_ = 1227,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1228,      /* -fprofile-partial-training */
  OPT_fprofile_reorder_functions = 1229,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1230,                /* -fprofile-report */
  OPT_fprofile_update_ = 1231,               /* -fprofile-update= */
  OPT_fprofile_use = 1232,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1233,                  /* -fprofile-use= */
  OPT_fprofile_values = 1234,                /* -fprofile-values */
  OPT_fprotect_parens = 1235,                /* -fprotect-parens */
  OPT_frandom_seed = 1236,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1237,                  /* -frandom-seed= */
  OPT_frange_check = 1238,                   /* -frange-check */
  OPT_freal_4_real_10 = 1239,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1240,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1241,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1242,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1243,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1244,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1245,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1246,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1247,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1248,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1249,               /* -frecord-marker=8 */
  OPT_frecursive = 1250,                     /* -frecursive */
  OPT_free = 1251,                           /* -free */
  OPT_freg_struct_return = 1252,             /* -freg-struct-return */
  /* OPT_fregmove = 1253, */                 /* -fregmove */
  OPT_frelease = 1254,                       /* -frelease */
  OPT_frename_registers = 1255,              /* -frename-registers */
  OPT_freorder_blocks = 1256,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1257,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1258,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1259,             /* -freorder-functions */
  OPT_frepack_arrays = 1260,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1261,          /* -freplace-objc-classes */
  OPT_frepo = 1262,                          /* -frepo */
  OPT_freport_bug = 1263,                    /* -freport-bug */
  OPT_frequire_return_statement = 1264,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1265,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1266, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1267,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1268,                   /* -fresolution= */
  OPT_frounding_math = 1269,                 /* -frounding-math */
  OPT_frtti = 1270,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1271,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1272,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1273,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1274,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1275,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1276,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1277,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1278,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1279, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1280,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1281,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1282,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1283,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1284,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1285,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1286,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1287,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1288,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1289,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1290,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1291,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1292,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1293,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1294,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1295,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1296, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1297,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1298,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1299,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1300,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1301,               /* -fsection-anchors */
  /* OPT_fsee = 1302, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1303,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1304,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1305,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1306,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1307,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1308,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1309,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1310,                   /* -fshort-enums */
  OPT_fshort_wchar = 1311,                   /* -fshort-wchar */
  OPT_fshow_column = 1312,                   /* -fshow-column */
  OPT_fshrink_wrap = 1313,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1314,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1315,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1316,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1317,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1318,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1319,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1320,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1321,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1322,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1323,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1324,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1325,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1326,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1327,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1328,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1329,                      /* -fsquangle */
  OPT_fssa_backprop = 1330,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1331,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1332,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1333,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1334, */             /* -fstack-check */
  OPT_fstack_check_ = 1335,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1336,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1337,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1338,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1339,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1340,               /* -fstack-protector */
  OPT_fstack_protector_all = 1341,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1342,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1343,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1344,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1345,                   /* -fstack-usage */
  OPT_fstats = 1346,                         /* -fstats */
  OPT_fstdarg_opt = 1347,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1348,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1349, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1350,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1351,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1352,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1353,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1354,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1355, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1356,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1357,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1358,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1359,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1360,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1361, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1362,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1363, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1364,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1365, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1366,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1367,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1368,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1369,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1370,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1371,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1372,                   /* -ftime-report */
  OPT_ftime_report_details = 1373,           /* -ftime-report-details */
  OPT_ftls_model_ = 1374,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1375,              /* -ftoplevel-reorder */
  OPT_ftracer = 1376,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1377,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1378,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1379,                   /* -ftrampolines */
  OPT_ftransition_all = 1380,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1381,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1382,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1383,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1384,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1385,              /* -ftransition=field */
  OPT_ftransition_import = 1386,             /* -ftransition=import */
  OPT_ftransition_nogc = 1387,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1388,                /* -ftransition=tls */
  OPT_ftrapping_math = 1389,                 /* -ftrapping-math */
  OPT_ftrapv = 1390,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1391,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1392,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1393,                      /* -ftree-ccp */
  OPT_ftree_ch = 1394,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1395, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1396,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1397,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1398, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1399,                   /* -ftree-cselim */
  OPT_ftree_dce = 1400,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1401,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1402,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1403,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1404,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1405, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1406,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1407,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1408, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1409,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1410,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1411, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1412,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1413,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1414,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1415,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1416,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1417,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1418,                      /* -ftree-pre */
  OPT_ftree_pta = 1419,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1420,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1421, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1422,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1423,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1424,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1425,                     /* -ftree-slsr */
  OPT_ftree_sra = 1426,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1427, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1428, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1429,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1430,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1431,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1432, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1433,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1434, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1435,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1436,         /* -funconstrained-commons */
  OPT_funderscoring = 1437,                  /* -funderscoring */
  OPT_funit_at_a_time = 1438,                /* -funit-at-a-time */
  OPT_funittest = 1439,                      /* -funittest */
  OPT_funroll_all_loops = 1440,              /* -funroll-all-loops */
  OPT_funroll_loops = 1441,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1442, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1443,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1444,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1445,                 /* -funsigned-char */
  OPT_funswitch_loops = 1446,                /* -funswitch-loops */
  OPT_funwind_tables = 1447,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1448,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1449,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1450,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1451,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1452,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1453,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1454,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1455,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1456,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1457,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1458,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1459, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1460,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1461,                   /* -fverbose-asm */
  /* OPT_fversion = 1462, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1463,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1464,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1465,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1466,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1467,                   /* -fvisibility= */
  OPT_fvpt = 1468,                           /* -fvpt */
  OPT_fvtable_gc = 1469,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1470,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1471,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1472,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1473,                     /* -fvtv-debug */
  OPT_fweak = 1474,                          /* -fweak */
  OPT_fweb = 1475,                           /* -fweb */
  /* OPT_fwhole_file = 1476, */              /* -fwhole-file */
  OPT_fwhole_program = 1477,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1478,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1479,             /* -fworking-directory */
  OPT_fwpa = 1480,                           /* -fwpa */
  OPT_fwpa_ = 1481,                          /* -fwpa= */
  OPT_fwrapv = 1482,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1483,                 /* -fwrapv-pointer */
  OPT_fxref = 1484,                          /* -fxref */
  /* OPT_fzee = 1485, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1486,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1487,                     /* -fzero-link */
  OPT_g = 1488,                              /* -g */
  OPT_gant = 1489,                           /* -gant */
  OPT_gas_loc_support = 1490,                /* -gas-loc-support */
  OPT_gas_locview_support = 1491,            /* -gas-locview-support */
  OPT_gcoff = 1492,                          /* -gcoff */
  OPT_gcoff1 = 1493,                         /* -gcoff1 */
  OPT_gcoff2 = 1494,                         /* -gcoff2 */
  OPT_gcoff3 = 1495,                         /* -gcoff3 */
  OPT_gcolumn_info = 1496,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1497,                 /* -gdescribe-dies */
  OPT_gdwarf = 1498,                         /* -gdwarf */
  OPT_gdwarf_ = 1499,                        /* -gdwarf- */
  OPT_gen_decls = 1500,                      /* -gen-decls */
  OPT_ggdb = 1501,                           /* -ggdb */
  OPT_ggnu_pubnames = 1502,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1503,                   /* -gimple-stats */
  OPT_ginline_points = 1504,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1505, /* -ginternal-reset-location-views */
  OPT_gnat = 1506,                           /* -gnat */
  OPT_gnatO = 1507,                          /* -gnatO */
  OPT_gno_ = 1508,                           /* -gno- */
  OPT_gno_pubnames = 1509,                   /* -gno-pubnames */
  OPT_gpubnames = 1510,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1511,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1512,                   /* -gsplit-dwarf */
  OPT_gstabs = 1513,                         /* -gstabs */
  OPT_gstabs_ = 1514,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1515,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1516,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1517,                        /* -gtoggle */
  OPT_gvariable_location_views = 1518,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1519,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1520,                           /* -gvms */
  OPT_gxcoff = 1521,                         /* -gxcoff */
  OPT_gxcoff_ = 1522,                        /* -gxcoff+ */
  OPT_gz = 1523,                             /* -gz */
  OPT_gz_ = 1524,                            /* -gz= */
  OPT_h = 1525,                              /* -h */
  OPT_help = 1526,                           /* -help */
  OPT_idirafter = 1527,                      /* -idirafter */
  OPT_imacros = 1528,                        /* -imacros */
  OPT_imultiarch = 1529,                     /* -imultiarch */
  OPT_imultilib = 1530,                      /* -imultilib */
  OPT_include = 1531,                        /* -include */
  OPT_iplugindir_ = 1532,                    /* -iplugindir= */
  OPT_iprefix = 1533,                        /* -iprefix */
  OPT_iquote = 1534,                         /* -iquote */
  OPT_isysroot = 1535,                       /* -isysroot */
  OPT_isystem = 1536,                        /* -isystem */
  OPT_iwithprefix = 1537,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1538,              /* -iwithprefixbefore */
  OPT_k8 = 1539,                             /* -k8 */
  OPT_l = 1540,                              /* -l */
  OPT_lang_asm = 1541,                       /* -lang-asm */
  OPT_list = 1542,                           /* -list */
  OPT_mabi_ = 1543,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1544,             /* -mabort-on-noreturn */
  OPT_mandroid = 1545,                       /* -mandroid */
  OPT_mapcs = 1546,                          /* -mapcs */
  OPT_mapcs_frame = 1547,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1548,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1549,              /* -mapcs-stack-check */
  OPT_march_ = 1550,                         /* -march= */
  OPT_marm = 1551,                           /* -marm */
  OPT_masm_syntax_unified = 1552,            /* -masm-syntax-unified */
  OPT_mbe32 = 1553,                          /* -mbe32 */
  OPT_mbe8 = 1554,                           /* -mbe8 */
  OPT_mbig_endian = 1555,                    /* -mbig-endian */
  OPT_mbionic = 1556,                        /* -mbionic */
  OPT_mbranch_cost_ = 1557,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1558,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1559,     /* -mcaller-super-interworking */
  OPT_mcmse = 1560,                          /* -mcmse */
  OPT_mcpu_ = 1561,                          /* -mcpu= */
  OPT_mfdpic = 1562,                         /* -mfdpic */
  OPT_mfix_cortex_m3_ldrd = 1563,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1564,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1565,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1566,                  /* -mfp16-format= */
  OPT_mfpu_ = 1567,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1568,             /* -mgeneral-regs-only */
  OPT_mglibc = 1569,                         /* -mglibc */
  /* OPT_mhard_float = 1570, */              /* -mhard-float */
  OPT_mlittle_endian = 1571,                 /* -mlittle-endian */
  OPT_mlong_calls = 1572,                    /* -mlong-calls */
  OPT_mmusl = 1573,                          /* -mmusl */
  OPT_mneon_for_64bits = 1574,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1575,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1576,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1577,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1578,               /* -mprint-tune-info */
  OPT_mpure_code = 1579,                     /* -mpure-code */
  OPT_mrestrict_it = 1580,                   /* -mrestrict-it */
  OPT_msched_prolog = 1581,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1582,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1583,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1584, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1585,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1586,                         /* -mthumb */
  OPT_mthumb_interwork = 1587,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1588,                  /* -mtls-dialect= */
  OPT_mtp_ = 1589,                           /* -mtp= */
  OPT_mtpcs_frame = 1590,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1591,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1592,                         /* -mtune= */
  OPT_muclibc = 1593,                        /* -muclibc */
  OPT_munaligned_access = 1594,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1595,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1596,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1597,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1598,              /* -mword-relocations */
  OPT_n = 1599,                              /* -n */
  OPT_name_sort = 1600,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1601,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1602,              /* -no-integrated-cpp */
  OPT_no_pie = 1603,                         /* -no-pie */
  OPT_nocpp = 1604,                          /* -nocpp */
  OPT_nodefaultlibs = 1605,                  /* -nodefaultlibs */
  OPT_nolibc = 1606,                         /* -nolibc */
  OPT_nophoboslib = 1607,                    /* -nophoboslib */
  OPT_nostartfiles = 1608,                   /* -nostartfiles */
  OPT_nostdinc = 1609,                       /* -nostdinc */
  OPT_nostdinc__ = 1610,                     /* -nostdinc++ */
  OPT_nostdlib = 1611,                       /* -nostdlib */
  OPT_o = 1612,                              /* -o */
  OPT_objects = 1613,                        /* -objects */
  OPT_p = 1614,                              /* -p */
  OPT_pass_exit_codes = 1615,                /* -pass-exit-codes */
  /* OPT_pedantic = 1616, */                 /* -pedantic */
  OPT_pedantic_errors = 1617,                /* -pedantic-errors */
  OPT_pg = 1618,                             /* -pg */
  OPT_pie = 1619,                            /* -pie */
  OPT_pipe = 1620,                           /* -pipe */
  OPT_posix = 1621,                          /* -posix */
  OPT_print_file_name_ = 1622,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1623,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1624,          /* -print-multi-directory */
  OPT_print_multi_lib = 1625,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1626,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1627,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1628,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1629,               /* -print-prog-name= */
  OPT_print_search_dirs = 1630,              /* -print-search-dirs */
  OPT_print_sysroot = 1631,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1632,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1633,                    /* -print-value */
  OPT_profile = 1634,                        /* -profile */
  OPT_pthread = 1635,                        /* -pthread */
  OPT_quiet = 1636,                          /* -quiet */
  OPT_r = 1637,                              /* -r */
  OPT_rdynamic = 1638,                       /* -rdynamic */
  OPT_remap = 1639,                          /* -remap */
  OPT_reverse_sort = 1640,                   /* -reverse-sort */
  OPT_s = 1641,                              /* -s */
  OPT_save_temps = 1642,                     /* -save-temps */
  OPT_save_temps_ = 1643,                    /* -save-temps= */
  OPT_shared = 1644,                         /* -shared */
  OPT_shared_libgcc = 1645,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1646,               /* -shared-libphobos */
  OPT_size_sort = 1647,                      /* -size-sort */
  /* OPT_specs = 1648, */                    /* -specs */
  OPT_specs_ = 1649,                         /* -specs= */
  OPT_static = 1650,                         /* -static */
  OPT_static_libasan = 1651,                 /* -static-libasan */
  OPT_static_libgcc = 1652,                  /* -static-libgcc */
  OPT_static_libgfortran = 1653,             /* -static-libgfortran */
  OPT_static_libgo = 1654,                   /* -static-libgo */
  OPT_static_liblsan = 1655,                 /* -static-liblsan */
  OPT_static_libmpx = 1656,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1657,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1658,               /* -static-libphobos */
  OPT_static_libstdc__ = 1659,               /* -static-libstdc++ */
  OPT_static_libtsan = 1660,                 /* -static-libtsan */
  OPT_static_libubsan = 1661,                /* -static-libubsan */
  OPT_static_pie = 1662,                     /* -static-pie */
  /* OPT_std_c__03 = 1663, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1664, */                /* -std=c++0x */
  OPT_std_c__11 = 1665,                      /* -std=c++11 */
  OPT_std_c__14 = 1666,                      /* -std=c++14 */
  OPT_std_c__17 = 1667,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1668, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1669, */                /* -std=c++1z */
  OPT_std_c__2a = 1670,                      /* -std=c++2a */
  OPT_std_c__98 = 1671,                      /* -std=c++98 */
  OPT_std_c11 = 1672,                        /* -std=c11 */
  OPT_std_c17 = 1673,                        /* -std=c17 */
  /* OPT_std_c18 = 1674, */                  /* -std=c18 */
  /* OPT_std_c1x = 1675, */                  /* -std=c1x */
  OPT_std_c2x = 1676,                        /* -std=c2x */
  /* OPT_std_c89 = 1677, */                  /* -std=c89 */
  OPT_std_c90 = 1678,                        /* -std=c90 */
  OPT_std_c99 = 1679,                        /* -std=c99 */
  /* OPT_std_c9x = 1680, */                  /* -std=c9x */
  OPT_std_f2003 = 1681,                      /* -std=f2003 */
  OPT_std_f2008 = 1682,                      /* -std=f2008 */
  OPT_std_f2008ts = 1683,                    /* -std=f2008ts */
  OPT_std_f2018 = 1684,                      /* -std=f2018 */
  OPT_std_f95 = 1685,                        /* -std=f95 */
  OPT_std_gnu = 1686,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1687, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1688, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1689,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1690,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1691,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1692, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1693, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1694,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1695,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1696,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1697,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1698, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1699, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1700,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1701, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1702,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1703,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1704, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1705, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1706,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1707, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1708, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1709, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1710, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1711, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1712,                     /* -std=legacy */
  OPT_symbol_ = 1713,                        /* -symbol= */
  OPT_symbolic = 1714,                       /* -symbolic */
  OPT_t = 1715,                              /* -t */
  OPT_time = 1716,                           /* -time */
  OPT_time_ = 1717,                          /* -time= */
  OPT_tno_android_cc = 1718,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1719,                 /* -tno-android-ld */
  OPT_traditional = 1720,                    /* -traditional */
  OPT_traditional_cpp = 1721,                /* -traditional-cpp */
  OPT_tree_stats = 1722,                     /* -tree-stats */
  OPT_trigraphs = 1723,                      /* -trigraphs */
  OPT_type_stats = 1724,                     /* -type-stats */
  OPT_u = 1725,                              /* -u */
  OPT_undef = 1726,                          /* -undef */
  OPT_v = 1727,                              /* -v */
  OPT_version = 1728,                        /* -version */
  OPT_w = 1729,                              /* -w */
  OPT_wrapper = 1730,                        /* -wrapper */
  OPT_x = 1731,                              /* -x */
  OPT_z = 1732,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
