...
enum opt_code
{
  ...
  OPT_mapcs = 1545,                          /* -mapcs */
  OPT_mapcs_frame = 1546,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1547,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1548,              /* -mapcs-stack-check */
  OPT_march_ = 1549,                         /* -march= */
  OPT_marm = 1550,                           /* -marm */
  OPT_masm_syntax_unified = 1551,            /* -masm-syntax-unified */
  OPT_mbe32 = 1552,                          /* -mbe32 */
  OPT_mbe8 = 1553,                           /* -mbe8 */
  OPT_mbig_endian = 1554,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1555,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1556,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1557,     /* -mcaller-super-interworking */
  OPT_mcmse = 1558,                          /* -mcmse */
  OPT_mcpu_ = 1559,                          /* -mcpu= */
  OPT_mfdpic = 1560,                         /* -mfdpic */
  OPT_mfix_cortex_m3_ldrd = 1561,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1562,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1563,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1564,                  /* -mfp16-format= */
  OPT_mfpu_ = 1565,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1566,             /* -mgeneral-regs-only */
  /* OPT_mhard_float = 1567, */              /* -mhard-float */
  OPT_mlittle_endian = 1568,                 /* -mlittle-endian */
  OPT_mlong_calls = 1569,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1570,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1571,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1572,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1573,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1574,               /* -mprint-tune-info */
  OPT_mpure_code = 1575,                     /* -mpure-code */
  OPT_mrestrict_it = 1576,                   /* -mrestrict-it */
  OPT_msched_prolog = 1577,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1578,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1579,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1580, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1581,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1582,                         /* -mthumb */
  OPT_mthumb_interwork = 1583,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1584,                  /* -mtls-dialect= */
  OPT_mtp_ = 1585,                           /* -mtp= */
  OPT_mtpcs_frame = 1586,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1587,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1588,                         /* -mtune= */
  OPT_munaligned_access = 1589,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1590,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1591,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1592,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1593,              /* -mword-relocations */
  OPT_n = 1594,                              /* -n */
  OPT_name_sort = 1595,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1596,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1597,              /* -no-integrated-cpp */
  OPT_no_pie = 1598,                         /* -no-pie */
  OPT_nocpp = 1599,                          /* -nocpp */
  OPT_nodefaultlibs = 1600,                  /* -nodefaultlibs */
  OPT_nolibc = 1601,                         /* -nolibc */
  OPT_nophoboslib = 1602,                    /* -nophoboslib */
  OPT_nostartfiles = 1603,                   /* -nostartfiles */
  OPT_nostdinc = 1604,                       /* -nostdinc */
  OPT_nostdinc__ = 1605,                     /* -nostdinc++ */
  OPT_nostdlib = 1606,                       /* -nostdlib */
  OPT_o = 1607,                              /* -o */
  OPT_objects = 1608,                        /* -objects */
  OPT_p = 1609,                              /* -p */
  OPT_pass_exit_codes = 1610,                /* -pass-exit-codes */
  /* OPT_pedantic = 1611, */                 /* -pedantic */
  OPT_pedantic_errors = 1612,                /* -pedantic-errors */
  OPT_pg = 1613,                             /* -pg */
  OPT_pie = 1614,                            /* -pie */
  OPT_pipe = 1615,                           /* -pipe */
  OPT_print_file_name_ = 1616,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1617,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1618,          /* -print-multi-directory */
  OPT_print_multi_lib = 1619,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1620,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1621,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1622,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1623,               /* -print-prog-name= */
  OPT_print_search_dirs = 1624,              /* -print-search-dirs */
  OPT_print_sysroot = 1625,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1626,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1627,                    /* -print-value */
  OPT_quiet = 1628,                          /* -quiet */
  OPT_r = 1629,                              /* -r */
  OPT_remap = 1630,                          /* -remap */
  OPT_reverse_sort = 1631,                   /* -reverse-sort */
  OPT_s = 1632,                              /* -s */
  OPT_save_temps = 1633,                     /* -save-temps */
  OPT_save_temps_ = 1634,                    /* -save-temps= */
  OPT_shared = 1635,                         /* -shared */
  OPT_shared_libgcc = 1636,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1637,               /* -shared-libphobos */
  OPT_size_sort = 1638,                      /* -size-sort */
  /* OPT_specs = 1639, */                    /* -specs */
  OPT_specs_ = 1640,                         /* -specs= */
  OPT_static = 1641,                         /* -static */
  OPT_static_libasan = 1642,                 /* -static-libasan */
  OPT_static_libgcc = 1643,                  /* -static-libgcc */
  OPT_static_libgfortran = 1644,             /* -static-libgfortran */
  OPT_static_libgo = 1645,                   /* -static-libgo */
  OPT_static_liblsan = 1646,                 /* -static-liblsan */
  OPT_static_libmpx = 1647,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1648,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1649,               /* -static-libphobos */
  OPT_static_libstdc__ = 1650,               /* -static-libstdc++ */
  OPT_static_libtsan = 1651,                 /* -static-libtsan */
  OPT_static_libubsan = 1652,                /* -static-libubsan */
  OPT_static_pie = 1653,                     /* -static-pie */
  /* OPT_std_c__03 = 1654, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1655, */                /* -std=c++0x */
  OPT_std_c__11 = 1656,                      /* -std=c++11 */
  OPT_std_c__14 = 1657,                      /* -std=c++14 */
  OPT_std_c__17 = 1658,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1659, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1660, */                /* -std=c++1z */
  OPT_std_c__2a = 1661,                      /* -std=c++2a */
  OPT_std_c__98 = 1662,                      /* -std=c++98 */
  OPT_std_c11 = 1663,                        /* -std=c11 */
  OPT_std_c17 = 1664,                        /* -std=c17 */
  /* OPT_std_c18 = 1665, */                  /* -std=c18 */
  /* OPT_std_c1x = 1666, */                  /* -std=c1x */
  OPT_std_c2x = 1667,                        /* -std=c2x */
  /* OPT_std_c89 = 1668, */                  /* -std=c89 */
  OPT_std_c90 = 1669,                        /* -std=c90 */
  OPT_std_c99 = 1670,                        /* -std=c99 */
  /* OPT_std_c9x = 1671, */                  /* -std=c9x */
  OPT_std_f2003 = 1672,                      /* -std=f2003 */
  OPT_std_f2008 = 1673,                      /* -std=f2008 */
  OPT_std_f2008ts = 1674,                    /* -std=f2008ts */
  OPT_std_f2018 = 1675,                      /* -std=f2018 */
  OPT_std_f95 = 1676,                        /* -std=f95 */
  OPT_std_gnu = 1677,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1678, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1679, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1680,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1681,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1682,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1683, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1684, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1685,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1686,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1687,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1688,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1689, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1690, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1691,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1692, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1693,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1694,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1695, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1696, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1697,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1698, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1699, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1700, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1701, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1702, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1703,                     /* -std=legacy */
  OPT_symbol_ = 1704,                        /* -symbol= */
  OPT_symbolic = 1705,                       /* -symbolic */
  OPT_t = 1706,                              /* -t */
  OPT_time = 1707,                           /* -time */
  OPT_time_ = 1708,                          /* -time= */
  OPT_traditional = 1709,                    /* -traditional */
  OPT_traditional_cpp = 1710,                /* -traditional-cpp */
  OPT_tree_stats = 1711,                     /* -tree-stats */
  OPT_trigraphs = 1712,                      /* -trigraphs */
  OPT_type_stats = 1713,                     /* -type-stats */
  OPT_u = 1714,                              /* -u */
  OPT_undef = 1715,                          /* -undef */
  OPT_v = 1716,                              /* -v */
  OPT_version = 1717,                        /* -version */
  OPT_w = 1718,                              /* -w */
  OPT_wrapper = 1719,                        /* -wrapper */
  OPT_x = 1720,                              /* -x */
  OPT_z = 1721,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
